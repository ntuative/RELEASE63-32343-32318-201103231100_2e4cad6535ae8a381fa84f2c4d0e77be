package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_892.push(_loc11_);
                  this.var_894.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_892.push(new XML());
               this.var_894.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_894[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1354 == true || this.var_893 == 0)
         {
            if(this.var_892.length > 0)
            {
               ++this._frame;
      ...
      {
         return this.var_1354 == false && this.var_893 == 1 && this.var_1624 != this._state;
      }
      ...
      private function updateAssetInWindow(param1:IBitmapWrapperWindow) : void
      {
         ...
         {
            _loc2_ = this.var_894[this._frame];
