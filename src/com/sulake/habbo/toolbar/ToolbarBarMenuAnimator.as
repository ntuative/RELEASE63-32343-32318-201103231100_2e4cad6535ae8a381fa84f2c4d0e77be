package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1273:Number = 25;
      
      private static const const_1269:Number = 90;
      
      private static const const_965:int = 50;
      
      private static const const_1354:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1459:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_780 = new Timer(const_1273);
      ...
      {
         return param1.x + param1.width < const_965 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_965 || param1.desktop.height - param1.y < const_1354;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1459.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1459.getIconLoc(param1.iconId);
      ...
      {
         return this.var_631[this.var_632.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_632[this.var_631.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_632.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_632.splice(_loc3_,1);
            this.var_631.splice(_loc3_,1);
         }
         this.var_631.push(param1.name);
         this.var_632.push(param2);
         param1.addEventListener(WindowEvent.const_342,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_262,this.windowEventListener);
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_631.length)
         {
            if(this.var_631[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_632[_loc2_];
               if(this.var_633[_loc3_] != null)
               {
                  _loc4_ = 0;
