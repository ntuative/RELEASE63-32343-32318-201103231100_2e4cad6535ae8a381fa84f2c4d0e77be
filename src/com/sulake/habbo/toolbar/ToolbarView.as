package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_542:String = "LEFT";
      ...
      private var var_1969:Number = 15;
      
      private var var_1968:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_232 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_61,HabboWindowStyle.const_1068,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1271 = String(_loc8_.relocate_by_drag.@state) == "AvailabilityTimeMessageParser";
         if(this.var_1271)
         {
         ...
         this.var_1969 = _loc8_.toolbar.@min_group_margin;
         this.var_1968 = _loc8_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc9_,this.var_276,param1,param2,param3,this._window,this.var_315);
         this.createGroupsFromXmlList(_loc10_,this.var_668,param1,param2,param3,this.var_232,this.var_315);
         this.alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(this.var_668.length > 0)
         {
            _loc1_ = this.var_668.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_172,this.var_542,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_542);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_172,this.var_542);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_172,this.var_542);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_1127);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_668.length)
         {
            _loc2_ = this.var_668[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_232.x = this.var_172 + this.var_1968;
               this.var_232.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_232.x = 0;
               this.var_232.y = this.var_172 + this.var_1968;
         ...
         else
         {
            ...
            if(this.var_276.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1969,(this._window.height - _loc5_ * _loc8_ - this._toolbarMarginTop - this._toolbarMarginBottom) / (this.var_276.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1969,(this._window.width - _loc5_ * _loc8_ - this._toolbarMarginTop - this._toolbarMarginBottom) / (this.var_276.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_276.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_542;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1271 && this.var_1534)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_542)
            {
               this.var_542 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_439);
                  _loc3_.orientation = this.var_542;
