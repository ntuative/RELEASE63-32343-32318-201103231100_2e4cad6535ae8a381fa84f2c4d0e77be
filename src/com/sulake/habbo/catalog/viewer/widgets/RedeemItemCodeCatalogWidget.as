package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_914.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_914 = null;
         }
         if(this.var_913 != null)
         {
            this.var_913.removeEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
            this.var_913 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_914 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_914 != null)
         {
            this.var_914.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_913 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_913 != null)
         {
            this.var_913.addEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
         }
         return true;
      }
