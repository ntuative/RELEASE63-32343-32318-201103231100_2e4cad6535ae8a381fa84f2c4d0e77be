package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1915:Point;
      
      private var var_537:IItemGridWindow;
      
      private var var_1504:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_999 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         this.var_1915 = new Point(this.var_88.x,this.var_88.y);
         this.var_537 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1504 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1916 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_999.text = _loc4_;
         this.var_1238.text = _loc5_;
         this.var_999.height = this.var_999.textHeight + 5;
         this.var_1238.y = this.var_999.y + this.var_999.height;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_458:
                  _loc6_ = this.var_1916.clone();
                  if(this.var_537 != null)
                  {
                     this.var_537.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_537,this.var_1504,this.var_1886);
                     ...
                     case ProductTypeEnum.const_189:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_279,AvatarAction.const_570);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2647)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2647 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_88 != null && true)
         {
            ...
            this.var_88.x = this.var_1915.x;
            this.var_88.y = this.var_1915.y;
            if(param3 != null)
            {
