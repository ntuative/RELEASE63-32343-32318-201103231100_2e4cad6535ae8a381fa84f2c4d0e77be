package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2156 = _loc3_.localizationId;
         this.var_339 = [];
         if(page && false && page.viewer.catalog)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         this.var_474 = param1.index;
         if(this.var_474 < 0 || this.var_474 > this.var_339.length)
         {
            this.var_474 = 0;
         }
         this.updateImage();
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_197 == null || this.var_699 >= this.var_197.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_474 >= 0 && this.var_474 < this.var_339.length)
         {
            _loc7_ = this.var_339[this.var_474] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_197[this.var_699] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_550,_loc3_,_loc2_,AvatarScaleType.const_56,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_279,AvatarAction.const_860);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_474 >= this.var_339.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_339[this.var_474] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_197[this.var_699] as int;
