package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1431:int = 18;
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_197 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1431 && _loc2_ < this.var_197.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_550,this.var_197[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_197 != null && this.var_197.length > 0)
         {
            ...
            this.var_393 = this.var_197[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_550,this.var_393),this.getRaceLocalizationKey(this.var_550,this.var_393));
            }
         }
         return this.getRaceLocalizationKey(this.var_550,this.var_393);
      }
      ...
      {
         if(param1.productCode == this.var_2156)
         {
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_393 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_550;
         var _loc3_:int = this.var_393;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_393 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
