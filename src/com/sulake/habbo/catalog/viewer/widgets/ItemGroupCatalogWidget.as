package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_601[this.var_1136][this.var_1713];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1136 = var_1043.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1136];
         var _loc3_:Array = this.var_601[this.var_1136] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1713 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1713] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_473 || _loc1_.pricingModel == Offer.const_545)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_73 || _loc3_.productType == ProductTypeEnum.const_86)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_601.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_601[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
