package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1736:String = "ctlg_";
       
      
      protected var var_2077:XML;
      ...
      {
         var _loc2_:String = const_1736 + param1;
         ...
         this.var_2077 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2077) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1589:
               if(this.var_1198 == null)
               {
                  this.var_1198 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1198);
               }
               break;
            case CatalogWidgetEnum.const_1526:
               this.var_48.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1468:
            ...
            case CatalogWidgetEnum.const_1530:
               ...
               break;
            case CatalogWidgetEnum.const_1710:
            ...
            case CatalogWidgetEnum.const_1446:
               ...
               break;
            case CatalogWidgetEnum.const_1477:
