package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1005:int = 0;
      ...
      {
         return this.var_677 != const_1005;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2021 != RecyclerStatusMessageEvent.const_1106;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_677 == const_426;
      }
      ...
      {
         this.var_677 = const_1006;
         this.var_125 = new Array(const_198);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_198)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_677 = const_1005;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1696:
               this.var_677 = const_426;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1106:
               if(this.var_16 == null || this.var_16.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1692:
               if(this.var_16 == null || this.var_16.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1076:
               if(this.var_16 != null)
               {
                  this.var_16.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1525:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_125.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_198)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_125.length < const_198)
         {
            return false;
         }
         var _loc1_:int = 0;
