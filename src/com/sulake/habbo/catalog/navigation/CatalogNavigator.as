package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2896:String = "magic.credits";
      
      private var var_2853:String = "magic.pixels";
      
      private var var_2852:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2853);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2852,true);
      }
