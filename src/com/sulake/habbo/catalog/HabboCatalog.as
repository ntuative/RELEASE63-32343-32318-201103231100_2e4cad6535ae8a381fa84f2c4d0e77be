package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_2354:GiftWrappingConfiguration;
      
      private var var_1123:ClubGiftController;
      ...
      private var var_1125:IPurchasableOffer;
      
      private var var_1126:Function;
      
      private var var_256:PlacedObjectPurchaseData;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_219.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_185.getKey("client.credits.embed.enabled","false") == "AvailabilityTimeMessageParser";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_185.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_320.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_320.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_73)
         {
            _loc3_ = this.var_320.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_104.getActivityPointsForType(Purse.const_202)));
         var _loc1_:int = 0;
      ...
      {
         this.var_186.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_782)
         {
            if(!this.var_320.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_186 != null && _loc2_)
         {
            this.var_186.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_301.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_301 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_301.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_81:
               this.var_1692 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1123 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_352.openPage(this.var_734);
            this.var_734 = "";
            this.var_925 = -1;
         }
         else if(this.var_925 > -1)
         {
            this.var_352.openPageById(this.var_925,this.var_1691);
            this.var_925 = -1;
            this.var_1691 = -1;
            this.var_734 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_301.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_301.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2356 && this.var_502 != null)
         {
            this.var_502.playSound(HabboSoundTypesEnum.const_1184);
         }
         this.var_2356 = false;
         if(this.var_302 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2355 && this.var_502 != null)
         {
            this.var_502.playSound(HabboSoundTypesEnum.const_1014);
         }
         this.var_2355 = false;
         if(this.var_302 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1123.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_301.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2354 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_735.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_735.add(_loc2_.productCode,_loc3_.slice());
            this.var_301.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "AvailabilityTimeMessageParser" == this.var_185.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_185.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_175)
         {
            _loc3_ = this.var_185.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      public function requestSelectedItemToMover(param1:Function, param2:Offer) : void
      {
         var _loc4_:int = 0;
         var _loc6_:Boolean = false;
         if(!this.var_185.keyExists("catalog.drag_and_drop") || this.var_185.getKey("catalog.drag_and_drop") != "AvailabilityTimeMessageParser")
         {
            return;
         }
      ...
      {
         if(this.var_1127 && param1.type == RoomEngineObjectEvent.const_159)
         {
            this.resetPlacedOfferData();
            if(this.var_1125 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_256 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1125);
            if(this.var_1126 != null)
            {
               this.var_1126.call(null,true);
            }
            this.resetObjectMover();
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         if(this.var_256 && this.var_256.productClassId == param1.classId)
         {
            if(this.var_256.roomCategory == this._roomEngine.activeRoomCategory && this.var_256.roomId == this._roomEngine.activeRoomId)
            {
               _loc2_ = param1.stripId;
               _loc3_ = this.var_256.category;
               _loc4_ = this.var_256.wallLocation;
               _loc5_ = this.var_256.x;
               _loc6_ = this.var_256.y;
               _loc7_ = this.var_256.direction;
