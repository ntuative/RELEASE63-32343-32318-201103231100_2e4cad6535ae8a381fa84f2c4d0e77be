package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_1669:IProductData;
      
      private var var_592:IFurnitureData;
      ...
      private function setOfferData(param1:IPurchasableOffer) : void
      {
         ...
         this.var_1668 = param1.productContainer.firstProduct.productClassId;
         this.var_1669 = param1.productContainer.firstProduct.productData;
         this.var_592 = param1.productContainer.firstProduct.furnitureData;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_356,this._category,this.var_1910,this._x,this.var_151,this._direction,this._offerId,this.var_1668].toString();
      }
