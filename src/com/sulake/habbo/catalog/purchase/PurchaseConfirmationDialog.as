package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2056:int = 10;
      ...
      private const const_2057:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1849 = _loc1_.stuffTypes;
            this.var_784 = _loc1_.boxTypes;
            this.var_785 = _loc1_.ribbonTypes;
            this.var_1210 = this.var_1849[0];
            this.var_375 = this.var_784[0];
            this.var_373 = this.var_785[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_373 < 0)
         {
            this.var_373 = this.var_785.length - 1;
         }
         if(this.var_373 > this.var_785.length - 1)
         {
            this.var_373 = 0;
         }
         if(this.var_375 < 0)
         {
            this.var_375 = this.var_784.length - 1;
         }
         if(this.var_375 > this.var_784.length - 1)
         {
            this.var_375 = 0;
         }
         var _loc1_:int = this.var_784[this.var_375] * 1000 + this.var_785[this.var_373];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_93.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1210,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1472 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1849;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1210);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_784[this.var_375]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_785[this.var_373]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_93,this.var_1473,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_93.offerId,this.var_1473);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               for each(_loc7_ in this.var_230)
               {
                  ...
                  if(_loc5_.length >= this.const_2056)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2575 = _loc3_.text;
               break;
      ...
      {
         if(this.var_268 == null || !this.var_268.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_268.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_268 == null)
         {
            this.var_268 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_640 == null)
         {
         ...
         if(this.var_268 == null || this.var_640 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_268.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_268.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1210;
               }
            }
            _loc4_++;
         }
