package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1745:String = "badge_bg_001_png";
      
      private const const_2024:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1350 = param7;
         this.var_2188 = param5;
         this.var_1619 = param6;
         this.var_80 = param10;
         this._assets = param8;
         this.var_320 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_133,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2210 = this.var_80.getBadgeName(this.var_293);
         this.var_2212 = this.var_80.getBadgeDesc(this.var_293);
         this.var_2211 = this.var_80.getAchievementNameForFacebook(this.var_293,this.var_320.userName,this.var_320.realName,this.var_1349);
         this.var_2214 = this.var_80.getAchievementDescForFacebook(this.var_293,this.var_320.userName,this.var_320.realName,this.var_1349);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2215 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_80.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1752.toString());
         this.var_80.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1350.toString());
         this.var_80.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1350.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1619;
         var _loc17_:String = this.var_1619 == 0 ? "pixels" : "activitypoints";
         this.var_80.registerParameter(_loc16_,_loc17_,"" + this.var_2188);
         _loc15_.caption = this.var_80.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1745);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2024) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_80.registerParameter(param1,"badge_name",this.var_2210);
         this.var_80.registerParameter(param1,"badge_desc",this.var_2212);
         this.var_80.registerParameter(param1,"badge_name_fb",this.var_2211);
         this.var_80.registerParameter(param1,"badge_desc_fb",this.var_2214);
         this.var_80.registerParameter(param1,"level",this.var_1349.toString());
         this.var_80.registerParameter(param1,"name",this.var_320.userName);
         return this.var_80.registerParameter(param1,"realname",this.var_320.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_320.events.removeEventListener(BadgeImageReadyEvent.const_133,this.onBadgeImageReady);
            this.var_320 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1745);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_293,this._feedTitleFb,this.var_2215,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2213));
