package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_955:int = 32;
      
      private static const const_1339:int = 4;
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2481,this.var_448,this.var_186,param1);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_627 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < this.var_224.length)
         {
            ...
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_627 + const_1339;
            _loc2_++;
         }
         return _loc1_;
      }
