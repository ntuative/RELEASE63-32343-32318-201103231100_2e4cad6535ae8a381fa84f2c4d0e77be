package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_483:IKeyExchange;
      
      private var var_888:String;
      
      private var var_16:HabboLoginDemoView;
      
      private var var_2206:PseudoRandom;
      ...
      private const const_1744:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_576 = param1;
            this.var_56.initConnection(HabboConnectionType.const_256);
         }
      }
      ...
      {
         if(this.var_56 && this.var_157 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_576 = this.var_157.getKey("sso.ticket",null);
         this.var_1618 = this.var_157.getKey("flash.client.url","");
         this.var_2208 = this.var_157.getKey("external.variables.txt","");
         if(this.var_217 == null)
         {
            this.var_217 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this.var_16.addEventListener(HabboLoginDemoView.const_430,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_56.mode = HabboConnectionType.const_1122;
            }
         }
         this.var_56.initConnection(HabboConnectionType.const_256);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_683);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2206 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_56.mode)
         {
            case HabboConnectionType.const_90:
               ...
               this.var_217.loadBannerImage(_loc7_ + "?token=" + this.var_1347,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1122:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1515:
               this.var_888 = this.generateRandomHexString(30);
               this.var_483 = new DiffieHellman(new BigInteger(this.var_157.getKey("connection.development.prime"),16),new BigInteger(this.var_157.getKey("connection.development.generator"),16));
               this.var_483.init(this.var_888);
               _loc8_ = this.var_483.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_483.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_483.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2206);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1618,this.var_2208));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1744,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2207)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1347);
         ...
         this.var_483 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_483.init(_loc14_);
            _loc15_ = this.var_483.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_888 = _loc14_;
            }
