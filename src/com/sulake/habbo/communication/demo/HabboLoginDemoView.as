package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_430:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_162.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_129,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1744,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_162.habboConfiguration.getKey("use.sso","false") == "AvailabilityTimeMessageParser")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1744,"/");
         ...
         {
            dispatchEvent(new Event(const_430));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_134.removeEventListener(SSOTicket.const_399,this.onParsedTicketSuccess);
            this.var_134.removeEventListener(SSOTicket.const_285,this.onParsedTicketFailure);
            this.var_134 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_134.addEventListener(SSOTicket.const_399,this.onParsedTicketSuccess);
         this.var_134.addEventListener(SSOTicket.const_285,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_162.shockwaveClientUrl = this.var_134.shockwaveClientUrl;
