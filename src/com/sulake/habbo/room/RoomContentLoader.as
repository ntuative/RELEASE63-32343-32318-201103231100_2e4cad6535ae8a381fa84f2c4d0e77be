package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_1782:int = 0;
      
      private static const const_996:int = 1;
      
      private static const name_3:int = 2;
      
      private static const const_425:String = "place_holder";
      
      private static const const_614:String = "wall_place_holder";
      
      private static const const_616:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_425;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2758 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2756 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2760 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2757 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_320.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc2_.type == "s")
            {
               ...
               if(this.var_387[_loc7_] == null)
               {
                  this.var_387[_loc7_] = 1;
               }
            }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2759)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_790));
            }
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_313;
         }
         return RoomObjectCategoryEnum.const_158;
      }
      ...
      {
         return [const_425,const_614,const_616,const_615,TILE_CURSOR,const_997];
      }
      ...
      {
         return this.var_1026.getValue(param1) as String;
      }
      ...
      {
         if(this.var_210 != null && this.var_210.hasWorldType(const_337 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_221 || param1 == RoomObjectVisualizationEnum.const_64 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2757 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_32:
                     if(this.var_387[_loc4_] == null)
                     {
                        this.var_387[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_401,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1535.getValue(param1) != null)
         {
            this.var_210 = this.var_1535.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_847,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2758.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1683);
               return;
            }
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1535.add(param1,_loc4_);
         this.var_210 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_813.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_813.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_813.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         if(this.getObjectCategory(const_337 + param1) == RoomObjectCategoryEnum.const_79)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_210.getWorldHeightScale(const_337 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_210 != null)
         {
            return this.var_210.getWorldScale(const_337 + param1);
         }
         return 32;
      }
