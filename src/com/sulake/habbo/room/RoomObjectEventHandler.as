package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_789,param1,param2,param3,param4));
         }
      }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_94:
            ...
            case RoomObjectDimmerStateUpdateEvent.const_62:
               ...
               break;
            case RoomObjectMoveEvent.const_338:
            ...
            case RoomObjectRoomAdEvent.const_470:
            ...
            case RoomObjectRoomAdEvent.const_282:
               ...
               break;
            case RoomObjectRoomActionEvent.const_515:
            case RoomObjectRoomActionEvent.const_1539:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_79)
         {
            ...
            if(_loc14_ != _loc10_ && _loc15_ != _loc10_)
            {
               ...
               if(_loc16_ != null)
               {
                  _loc16_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_536,param2,param3,-1,RoomObjectCategoryEnum.const_158));
               }
         ...
         if(_loc6_ == null)
         {
            ...
            if(_loc6_ != null)
            {
               if(_loc5_.category == RoomObjectCategoryEnum.const_32)
               {
                  ...
                  {
                     _loc9_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_748);
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.const_510:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_544:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_636));
               break;
            case RoomObjectFurnitureActionEvent.const_454:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_578));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_451:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1532));
               break;
            case RoomObjectFurnitureActionEvent.const_513:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_653));
               break;
            case RoomObjectFurnitureActionEvent.const_576:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_578));
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_826);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_1242);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_376,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1489,category) as IRoomObjectController;
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               else if(_loc5_ == RoomObjectCategoryEnum.const_27)
               {
                  ...
                  if(_loc13_ != null)
                  {
                     _loc8_ = _loc13_.getOldLocationString(_loc12_,_loc11_);
                  }
               }
               _loc11_ = (_loc11_ / 45 % 8 + 8) % 8;
               if(_loc5_ == RoomObjectCategoryEnum.const_34 && _loc3_.typeId == RoomObjectTypeEnum.const_177)
               {
                  this._roomEngine.connection.send(new PlacePetMessageComposer(_loc4_,_loc9_,_loc10_));
               }
               else
               {
                  this._roomEngine.connection.send(new PlaceObjectMessageComposer(_loc4_,_loc5_,_loc8_,_loc9_,_loc10_,_loc11_));
               }
            }
         }
         var _loc7_:SelectedRoomObjectData = new SelectedRoomObjectData(_loc3_.id,_loc3_.category,null,null,null);
         this._roomEngine.setPlacedObjectData(param1,param2,_loc7_);
         this.resetSelectedObjectData(param1,param2);
         if(this._roomEngine && this._roomEngine.events)
         {
            _loc14_ = _loc6_ && _loc6_.getId() == _loc3_.id;
            this._roomEngine.events.dispatchEvent(new RoomEngineObjectPlacedEvent(RoomEngineObjectEvent.const_159,param1,param2,_loc4_,_loc5_,_loc8_,_loc9_,_loc10_,_loc11_,_loc14_));
         }
      }
