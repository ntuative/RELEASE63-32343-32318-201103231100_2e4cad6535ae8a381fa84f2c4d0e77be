package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1014:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this.var_279 = param1;
         this._height = param2;
         this.var_493 = this.var_279;
         this.var_492 = -1;
         this.var_491 = this._height;
         this.var_490 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_279 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_493 || param1 == this.var_492)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_491;
               ...
               if(param2 == this.var_491 || param2 == this.var_490)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_493;
                  while(_loc8_ < this.var_492)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_1014 = getFloorHeight(this.var_161);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_170,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_131) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_170,Vector3d.sum(param1,Vector3d.product(param3,-this.var_131 / param3.length)),Vector3d.product(param3,(param3.length + this.var_131) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_176,_loc13_,new Vector3d(0,0,-this.var_131),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_176,_loc13_,new Vector3d(0,0,-this.var_131),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_176,_loc13_,new Vector3d(0,0,-this.var_131),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_176,_loc13_,new Vector3d(0,0,-this.var_131),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
