package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1571:String = "cone";
      
      public static const const_1528:String = "plane";
      
      public static const const_1517:String = "sphere";
      ...
      public function reset() : void
      {
         ...
         this.var_1005 = 0;
         this.var_941 = false;
         this.init(0,0,0,this._direction,this.var_2678,this.var_1004,this.var_2676,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1256.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_941 = true;
         if(this.var_1005 < this.var_1514)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2675)
         {
            switch(this.var_2677)
            {
               case const_1571:
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1005 < this.var_1514)
         {
            if(this.age % this.var_2673 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1005 < this.var_1514)
         {
            ...
            this.y = (2 - this.var_272) * this.y - (1 - this.var_272) * this.lastY + this.var_1929 * this.var_1004 * this.var_1004;
         ...
         for each(_loc2_ in this.var_383)
         {
            ...
            _loc2_.y = (2 - this.var_272) * _loc2_.y - (1 - this.var_272) * _loc2_.lastY + this.var_1929 * this.var_1004 * this.var_1004;
