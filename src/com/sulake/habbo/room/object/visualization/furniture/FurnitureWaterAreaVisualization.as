package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1426:String = "shore";
      ...
      {
         if(this.var_2799 == param1 && this.var_2800 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1426)
            {
               this.var_2003 = _loc2_;
               this.var_2799 = param1;
               this.var_2800 = direction;
               return this.var_2003;
            }
            _loc2_--;
         }
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_546 + 2;
         var _loc4_:int = this.var_675 + 2;
         var _loc5_:int = 0;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_676[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_676[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_546 == 0 || this.var_675 == 0)
         {
            ...
            this.var_546 = _loc2_.getNumber(RoomObjectVariableEnum.const_288);
            this.var_675 = _loc2_.getNumber(RoomObjectVariableEnum.const_367);
         }
         this.var_456 = [];
         this.var_676 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_546 * 2 + this.var_675 * 2)
         {
            this.var_456.push(false);
            this.var_676.push(ShoreMaskCreatorUtility.const_74);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_546 + 2;
         var _loc2_:int = this.var_675 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_71,getSize(param3),this.var_456,this.var_676,assetCollection);
      }
