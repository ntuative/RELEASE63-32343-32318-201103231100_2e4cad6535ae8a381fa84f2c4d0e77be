package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      public function FurniturePlanetSystemVisualizationPlanetObject(param1:String, param2:int, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         ...
         this.var_2534 = param4 * 0 * 2 / 360;
         this.var_1823 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_1188 = 0;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1188 += this.var_2534 / const_1350;
      ...
      {
         var _loc3_:Number = this.var_1373 * Math.cos(this.var_1188 + this.var_1823);
         var _loc4_:Number = this.var_1373 * Math.sin(this.var_1188 + this.var_1823);
