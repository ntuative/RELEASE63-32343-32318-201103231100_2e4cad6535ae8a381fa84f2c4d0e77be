package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemParticle
   {
      ...
      public function init(param1:Number, param2:Number, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:int, param8:Boolean = false, param9:Array = null, param10:Boolean = false) : void
      {
         ...
         this.var_1739 = this.var_151 - this._direction.y * param6;
         this.var_1738 = this.var_152 - this._direction.z * param6;
         this.var_505 = 0;
         this.var_1147 = false;
         this.var_942 = param7;
         ...
         this.var_1441 = 0.5 + Math.random() * 0.5;
      }
      
      public function update() : void
      {
         ++this.var_505;
         if(this.var_505 == this.var_942)
         {
            this.ignite();
         }
         if(this.var_1740)
         {
            if(this.var_505 / this.var_942 > this.var_1441)
            {
               this._alphaMultiplier = (this.var_942 - this.var_505) / (this.var_942 * (1 - this.var_1441));
            }
         }
      }
      ...
      public function getAsset() : IGraphicAsset
      {
         ...
         {
            return this._frames[this.var_505 % this._frames.length];
         }
         return null;
      }
      ...
      {
         return this.var_505 <= this.var_942;
      }
