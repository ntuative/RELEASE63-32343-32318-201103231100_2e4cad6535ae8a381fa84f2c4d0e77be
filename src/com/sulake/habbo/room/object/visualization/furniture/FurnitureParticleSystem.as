package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1419:ColorTransform;
      
      private var var_1733:Matrix;
      
      private var _translationMatrix:Matrix;
      
      private var var_806:Number = 1.0;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_1419 = new ColorTransform();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_96 = this.var_1145[param1];
         this.var_941 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1732 >= 0)
         {
            this.var_258 = this._visualization.getSprite(this.var_1732);
            if(this.var_258 && this.var_258.asset)
            {
               ...
               if(this.var_86 == null)
               {
                  this.var_86 = this.var_258.asset.clone();
                  if(this.var_754.alphaMultiplier != 1)
                  {
                     this.var_612 = new BitmapData(this.var_86.width,this.var_86.height,true,4278190080);
                  }
               }
               this.var_2433 = -this.var_258.offsetX;
               this.var_2434 = -this.var_258.offsetY;
               this.var_258.asset = this.var_86;
            }
            if(this.var_86)
            {
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_96.y * this.var_1144;
         }
         return 0;
      }
      ...
      {
         if(!this.var_96 || !this.var_258)
         {
            return;
         }
         if(this.var_86 && this.var_258.asset != this.var_86)
         {
            this.var_258.asset = this.var_86;
         }
         if(this.var_941)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_941 && this.var_96.hasIgnited)
         {
            this.var_941 = true;
         }
         _loc8_ = this.var_1097 * this.var_1144;
         this.var_96.update();
         if(this.var_941)
         {
            if(this.var_96.roomObjectSpriteId >= 0)
            ...
            {
               this.var_86.draw(this.var_612,this.var_1733,this.var_754,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_96.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2433 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1144;
               _loc4_ = this.var_2434 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1144;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1419.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_86.draw(_loc7_,this._translationMatrix,this.var_1419,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2432 = parseInt(param1.@size);
         ...
         this.var_1144 = this.var_2432 / 64;
         this.var_806 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_806 = Math.min(this.var_806,1);
         this.var_754.alphaMultiplier = this.var_806;
         for each(_loc3_ in param1.emitter)
         {
            ...
            for each(_loc23_ in _loc3_.particles.particle)
            {
               ...
               _loc20_ = _loc23_.hasOwnProperty("@fade") && _loc23_.@fade == "AvailabilityTimeMessageParser" ? true : false;
               _loc21_ = [];
