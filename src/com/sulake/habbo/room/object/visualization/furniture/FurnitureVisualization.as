package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1740:Number = Math.sqrt(0.5);
      ...
      private var var_2765:Number = 0.0;
      
      private var var_2764:int = -1;
      
      private var var_2763:int = -1;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1536 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1536;
            this.var_1536 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_627 != spriteCount)
         {
            createSprites(this.var_627);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2571;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_365:
               break;
            case LayerData.const_1069:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1129:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_461 != _loc3_.getUpdateID() || param1 != var_101 || param2 != this.var_2761)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2762 = _loc3_.getNumber(RoomObjectVariableEnum.const_257);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_376));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1273 = _loc3_.getString(RoomObjectVariableEnum.const_408);
            if(this.var_1273 == null || this.var_1273.indexOf("http") != 0)
            {
               this.var_1273 = null;
            }
            this.var_2571 = this.var_1273 != null;
      ...
      {
         if(this.var_2763 != param2 || this.var_2765 != param1)
         {
            this.var_1027 = [];
            this.var_1028 = [];
            this.var_815 = [];
            ...
            this.var_2764 = this.getSize(param1);
      ...
      {
         this.var_627 = param1;
         this.var_1980 = this.var_627 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc3_:String = this.var_1027[param2];
         var _loc4_:Boolean = this.var_1028[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2764;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1980)
            {
      ...
      {
         if(this.var_819[param3] != null && !this.var_1979)
         {
      ...
      {
         if(this.var_816[param2] != null)
         {
            return this.var_816[param2];
         }
         if(this._data == null)
         {
