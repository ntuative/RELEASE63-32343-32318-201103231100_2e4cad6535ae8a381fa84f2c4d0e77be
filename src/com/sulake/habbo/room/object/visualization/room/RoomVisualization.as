package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1653:int = 13421772;
      
      private static const const_953:int = 16777215;
      
      private static const const_950:int = 13421772;
      
      private static const const_952:int = 10066329;
      
      private static const const_951:int = 10066329;
      
      public static const const_1460:int = 16777215;
      
      public static const const_1636:int = 13421772;
      
      public static const const_1455:int = 10066329;
      ...
      private var var_742:Rectangle = null;
      ...
      private var var_2380:String = null;
      
      private var var_1135:uint = 16777215;
      
      private var var_2383:int = 255;
      ...
      private const const_2045:int = 250;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_742 = super.boundingRectangle;
         }
         return new Rectangle(this.var_742.x,this.var_742.y,this.var_742.width,this.var_742.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1031);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1246);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1644)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_112,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_293)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         _loc9_ = param2;
         if(_loc9_ < this.var_1966 + this.const_2045 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_353.length)
            {
               _loc11_ = this.var_600[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_353[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1710)
                  {
                     ...
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2382 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2383 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1672)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1389 || _loc3_.y != this.var_2318 || _loc3_.z != this.var_2316 || param1.scale != this.var_2315))
            {
               this.var_1389 = _loc3_.x;
               this.var_2318 = _loc3_.y;
               this.var_2316 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1029);
            if(_loc3_ != this.var_2380)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2380 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_649));
            if(_loc4_ != this.var_1135)
            {
               this.var_1135 = _loc4_;
               this.var_2381 = this.var_1135 & 255;
               this.var_2382 = this.var_1135 >> 8 & 255;
               this.var_2383 = this.var_1135 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1209));
            if(_loc5_ != this.var_1710)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_175 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_665);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_770);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_876);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_663));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_654));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_765));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_353;
         if(this.var_353.length == 0)
         {
            _loc6_ = this.var_132;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_353.length > 0;
         var _loc9_:int = 0;
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1709;
      }
         ...
         while(_loc8_ < this.var_499.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_132.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_112 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_112 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_272)
                              {
