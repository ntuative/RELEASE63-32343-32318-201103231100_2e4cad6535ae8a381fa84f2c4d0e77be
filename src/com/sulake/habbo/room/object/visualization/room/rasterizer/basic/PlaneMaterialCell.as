package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_581 != null)
         {
            _loc2_ = this.var_581.getBitmap(param1);
            if(_loc2_ != null)
            {
         ...
         if(this.var_581 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  _loc3_ = Math.min(this.var_1091,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_1091,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_1091,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = this._extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = this.var_896[_loc6_ % this.var_896.length] as IGraphicAsset;
