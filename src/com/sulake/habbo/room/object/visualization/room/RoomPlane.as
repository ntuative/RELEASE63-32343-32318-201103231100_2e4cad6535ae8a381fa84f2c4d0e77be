package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_703:PlaneMaskManager = null;
      ...
      private var var_410:PlaneBitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2218 = param11;
         this.var_2217 = param12;
         this.var_891 = param6;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_596);
                  return param1;
               }
            }
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_410;
         if(_loc3_ == null)
         {
         ...
         if(this.var_716 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_345))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_889 != null)
            {
               _loc3_ = this.var_889.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1621,this.var_2220,this.var_2221,this.var_2218,this.var_2217,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(geometryChanged)
         {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_158.z - originZ,this.var_117.z - originZ,this.var_85.z - originZ,this.var_118.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2219 = relativeDepth;
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2216);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_112 || this._type == TYPE_LANDSCAPE)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_112 || this._type == TYPE_LANDSCAPE))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_245.length == this.var_890.length)
         {
         ...
         if(this.var_346.length > this.var_1351.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_891 || this.var_245.length == 0 && this.var_346.length == 0 && !this.var_345 || this.var_703 == null)
         {
            return;
         }
         ...
         if(this.var_345)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_578);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_245.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc3_.leftSideLoc / this.var_299.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc3_.rightSideLoc / this.var_300.length;
                  _loc12_ = _loc3_.type;
                  this.var_703.updateMask(this.var_71,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_346.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc4_.leftSideLoc / this.var_299.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc4_.rightSideLoc / this.var_300.length;
                  _loc13_ = this.var_71.width * _loc4_.leftSideLength / this.var_299.length;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_218.copyChannel(param1,param1.rect,const_596,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_218.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_218,this.var_218.rect,const_596,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
