package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1864:int = 16777216;
      ...
      private var var_1825:int = 16777216;
      ...
      {
         var _loc1_:int = this.var_2869 * this.var_1826 + this.var_2870;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1825;
         this.var_1826 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1825 * param2);
      }
   }
}
