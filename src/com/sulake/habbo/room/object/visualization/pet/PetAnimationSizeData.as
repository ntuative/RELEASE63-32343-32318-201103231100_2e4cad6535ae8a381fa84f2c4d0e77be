package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public static const const_743:int = -1;
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_714 = param1.@defaultPosture;
         }
         else
         {
            this.var_714 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_577.add(_loc6_,_loc7_);
         ...
         if(this.var_577.getValue(this.var_714) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_715.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      public function getAnimationForPosture(param1:String) : int
      {
         ...
         return int(this.var_577.getValue(param1));
      }
      ...
      public function getAnimationForGesture(param1:String) : int
      {
         ...
         return int(this.var_715.getValue(param1));
      }
      ...
      public function getPostureForAnimation(param1:int) : String
      {
         ...
         {
            return this.var_577.getKey(param1);
         }
         return this.var_714;
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_715.length)
         {
