package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1265:String = "head";
      
      private static const const_593:int = 1;
      
      private static const const_929:int = 1000;
      
      private static const const_1266:String = "pet_experience_bubble_png";
      
      private static const const_1264:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1266) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_343 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2183)
            {
               this.var_2183 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_175)
         {
            ...
            this.var_1862 = _loc3_.getNumber(RoomObjectVariableEnum.const_392) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_183);
            if(!isNaN(_loc8_))
            {
            ...
            {
               this.var_1604 = direction;
            }
            this.var_1334 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2184 = _loc3_.getNumber(RoomObjectVariableEnum.const_854);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_761);
            if(_loc9_ != this.var_1603)
            {
               this.var_1603 = _loc9_;
               this.var_2185 = this.var_1603.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_343 != null)
         {
            ...
            if(this.var_1334 > 0)
            {
               _loc2_ = param1 - this.var_1334;
               if(_loc2_ < const_929)
               {
                  this.var_343.alpha = int(Math.sin(_loc2_ / const_929 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_343.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_343.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_593;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2185);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_593)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_593))
            {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1604);
         }
         return direction;
      }
      ...
      {
         if(this.var_879[param1] == null)
         {
            if(this._animationData.getTag(var_101,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1265)
            {
               this.var_879[param1] = true;
            }
            else
            {
               this.var_879[param1] = false;
            }
         }
         return this.var_879[param1];
      }
   }
}
