   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2384)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_183,_loc4_.dirHead);
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_392,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_854,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_186);
            _loc2_.setString(RoomObjectVariableEnum.const_186,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1606,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_761,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_183,_loc3_ + this.var_929);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1711;
            _loc2_.setNumber(RoomObjectVariableEnum.const_249,this.var_1711);
            _loc2_.setNumber(RoomObjectVariableEnum.const_143,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1712;
            _loc2_.setNumber(RoomObjectVariableEnum.const_143,this.var_1712);
         }
         else
         {
            this.var_929 += 45;
