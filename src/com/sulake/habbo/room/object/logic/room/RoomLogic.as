package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1435:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_466,RoomObjectMouseEvent.const_152];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1031,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_649,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_663,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1167)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1789;
            if(_loc2_ - this.var_1167 >= this.var_1790)
            {
               _loc3_ = this.var_1168;
               _loc4_ = this.var_1791;
               this.var_1167 = 0;
            }
            else
            {
               _loc7_ = this.var_1435 >> 16 & 255;
               _loc8_ = this.var_1435 >> 8 & 255;
               _loc9_ = this.var_1435 & 255;
               _loc10_ = this.var_1168 >> 16 & 255;
               _loc11_ = this.var_1168 >> 8 & 255;
               _loc12_ = this.var_1168 & 255;
               _loc13_ = (_loc2_ - this.var_1167) / this.var_1790;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1788 + (this.var_1791 - this.var_1788) * _loc13_;
               this._color = _loc3_;
               this.var_1789 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_649,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_757:
               param2.setString(RoomObjectVariableEnum.const_770,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_830:
               param2.setString(RoomObjectVariableEnum.const_665,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_797:
               param2.setString(RoomObjectVariableEnum.const_876,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_488:
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_889:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1029,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1202:
               param2.setNumber(RoomObjectVariableEnum.const_663,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1164:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1209,int(param1.bgOnly));
         this.var_1435 = this._color;
         this.var_1788 = this.var_1789;
         this.var_1168 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_547,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1711,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1522,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1660,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_547,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_170 || _loc12_ == RoomPlaneData.const_293)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
