package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1275.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_81 = param2;
         this.var_1274 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1274.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1274.setValue(1);
         this.var_1275 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1275.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1275.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1274.setValue(_loc3_);
         this.var_1275.setValue(_loc4_);
      }
