package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1909:IWindowContainer;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1909 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1230 = this.var_1909.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1230)
         {
            this.var_1230.procedure = this.onButtonClick;
         }
         this.var_1231 = this.var_1909.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1231)
         {
            this.var_1231.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_271 >= this.var_80.length - 1)
         {
            this.var_1231.disable();
         }
         else
         {
            this.var_1231.enable();
         }
         if(this.var_271 <= 0)
         {
      ...
      {
         ++this.var_271;
         this.var_271 = Math.min(this.var_271,this.var_80.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_80[this.var_271][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_80[this.var_271][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_80[this.var_271][1]).value;
