package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1660:TriggerConfs;
      
      private var var_1661:ActionTypes;
      
      private var var_1659:ConditionTypes;
      ...
      {
         this.var_1660 = new TriggerConfs();
         this.var_1661 = new ActionTypes();
         this.var_1659 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1112 = new SliderWindowController(this.var_81,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_81.assets,0,20,1);
         this.var_1112.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1112.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_728.hideAll(this.var_252);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_728.showAll(this.var_252);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1112.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1112.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1384) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1384 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1660);
         this.refreshConfigureElement(this.var_1661);
         this.refreshConfigureElement(this.var_1659);
