package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1783)
         {
            this.gotoRoom(this.var_2478,this.var_2480,this.var_1784);
            this.var_1783 = false;
            this.var_1784 = "";
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1071:
                  break;
               case RoomSessionHandler.const_1161:
                  break;
               case RoomSessionHandler.const_915:
