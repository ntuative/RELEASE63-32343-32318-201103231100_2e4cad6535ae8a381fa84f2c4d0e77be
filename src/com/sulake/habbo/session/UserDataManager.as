package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1422:int = 1;
      
      private static const const_1423:int = 2;
      ...
      {
         return this.getUserDataByType(param1,const_1422);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_1032.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         this.var_1032.remove(param1);
         this.var_1032.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1423);
      }
