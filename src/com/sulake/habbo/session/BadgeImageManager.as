package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1065:String = "group_badge";
      
      public static const const_1439:String = "normal_badge";
       
      
      private const const_1773:String = "badge_";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = this.const_1773 + param1;
         ...
         switch(param2)
         {
            case const_1439:
               ...
               {
                  _loc5_ = this.var_185.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1065:
               if(this.var_185 != null)
               {
                  if(this.var_185 != null)
                  {
                     _loc5_ = this.var_185.getKey("group.badge.url");
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_1773,"");
