package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2053:int = 2500;
      ...
      public function sendChatMessage(param1:String) : void
      {
         ...
         this.var_1425.add(this.var_1426,getTimer());
         ++this.var_1426;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1425.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2053)
            {
