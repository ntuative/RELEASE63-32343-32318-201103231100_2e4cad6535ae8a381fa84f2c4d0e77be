package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_1093:int = 4;
      
      private static const const_995:int = 1;
      
      private static const const_613:int = 2;
      ...
      private var var_1265:OfficialRoomListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1265 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_260 = ITabContextWindow(this.var_17.findChildByName("tab_context"));
         if(!this.var_260)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_191 = IWindowContainer(this.var_17.findChildByName("tab_content"));
         this.var_231 = IWindowContainer(this.var_17.findChildByName("custom_content"));
         this.var_209 = IWindowContainer(this.var_17.findChildByName("list_content"));
         this.var_275 = IWindowContainer(this.var_17.findChildByName("custom_footer"));
         this.var_1527 = this.var_17.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_17.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1267 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         if(!this.var_1267)
         {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1469,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_191,["custom_content","list_content"],this.var_231.y,8);
         this.var_209.height = this.var_209.height + _loc1_ - this.var_209.y - this.var_275.height + this.var_2745;
         Util.moveChildrenToColumn(this.var_191,["list_content","custom_footer"],this.var_209.y,0);
         this.var_2745 = this.var_275.height;
      ...
      {
         this.refreshList(param1,param2,this.var_1265,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_666 == const_995)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_209.blend - _loc2_));
            this.var_209.blend = _loc3_;
            this.var_231.blend = !!this.var_1266 ? Number(_loc3_) : Number(1);
            this.var_275.blend = !!this.var_1266 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_666 = const_613;
            }
         }
         else if(this.var_666 == const_613)
         {
            if(this.var_1528 % 10 == 1)
            {
               this.var_1527.visible = !this.var_1527.visible;
            }
            ++this.var_1528;
            if(!this._navigator.data.isLoading())
            {
               this.var_666 = const_994;
            }
         }
         else if(this.var_666 == const_994)
         {
            this.refresh();
            this.var_666 = const_1417;
         }
         else
         {
