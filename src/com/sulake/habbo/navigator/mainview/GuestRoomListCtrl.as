package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_549:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_549 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_558 = IScrollbarWindow(this.var_191.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         this.var_191.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1568,true);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(this.var_549.visible && this.var_2815)
            {
               return;
            }
            ...
            this.var_549.room = _loc4_;
            this.var_549.showPopup(param2);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2816 - _loc2_.stageX);
         this.var_2816 = _loc2_.stageX;
         this.var_2815 = _loc3_ > 2;
      }
   }
}
