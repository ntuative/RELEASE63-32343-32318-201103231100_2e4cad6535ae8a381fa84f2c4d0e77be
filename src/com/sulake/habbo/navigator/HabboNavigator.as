package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_310:MainViewCtrl;
      
      private var var_614:RoomInfoViewCtrl;
      
      private var var_1148:RoomCreateViewCtrl;
      ...
      private var var_2906:Dictionary;
      ...
      private var var_2198:RoomThumbnailRenderer;
      
      private var var_876:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_310 = new MainViewCtrl(this);
         this.var_614 = new RoomInfoViewCtrl(this);
         this.var_1148 = new RoomCreateViewCtrl(this);
         this.var_2198 = new RoomThumbnailRenderer(this);
         this.var_876 = new GuestRoomPasswordInput(this);
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1457 = new IncomingMessages(this);
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_614.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_186.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_186.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_186.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_185.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_310.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_310.startSearch(Tabs.const_266,Tabs.const_395,param1);
         this.var_310.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_310.startSearch(Tabs.const_292,Tabs.const_220);
         this.var_447.getTab(Tabs.const_292).tabPageDecorator.tabSelected();
      }
