package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1650 = IButtonWindow(this.find("bg_tab"));
         this.var_1649 = IButtonWindow(this.find("top_tab"));
         this.var_1648 = IButtonWindow(this.find("obj_tab"));
         this.var_2278 = IWindowContainer(this.find("tile_grid"));
         ...
         Util.setProcDirectly(this.var_1650,this.onBgTabButton);
         Util.setProcDirectly(this.var_1649,this.onTopTabButton);
         Util.setProcDirectly(this.var_1648,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1650,this.var_68.mode != ThumbnailEditorModel.const_39);
         this.setEnabled(this.var_1649,this.var_68.mode != ThumbnailEditorModel.const_59);
         this.setEnabled(this.var_1648,this.var_68.mode != ThumbnailEditorModel.const_35);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2278;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_447,HabboWindowStyle.const_42,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_297,HabboWindowStyle.const_42,HabboWindowParam.const_60,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
