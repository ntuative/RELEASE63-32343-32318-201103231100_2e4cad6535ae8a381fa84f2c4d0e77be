package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1195)
         {
            this._navigator.data.eventMod = true;
         }
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1671)
         {
      ...
      {
         if(this._navigator.configuration.getKey("roomenterad.habblet.enabled") == "AvailabilityTimeMessageParser" && false)
         {
