package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2198 = new RoomThumbnailRenderer(param1);
         this.var_1173 = new TagRenderer(param1,hideInstantly);
      }
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1173.refreshTags(_loc1_,this.var_115.tags);
         ...
         this.var_2198.refreshThumbnail(_loc1_,this.var_115.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_266,Tabs.const_234,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
