package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_408:IRoomSettingsCtrlOwner;
      ...
      private var var_876:TextFieldManager;
      ...
      private var var_573:ICheckBoxWindow;
      ...
      private var var_2173:ITextWindow;
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1595 = true;
         this.var_408.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_340 || this.var_1074 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1074 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1582)
         {
            this.var_702.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1499)
         {
            this.var_702.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1715)
         {
            this.var_1071.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1481)
         {
            this.setTagError(this.var_875,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_877,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1485)
         {
            this.setTagError(this.var_875,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_877,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1656)
         {
            this.var_876.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_702.displayError("Update failed: error " + param2);
         }
      }
      ...
      {
         this.var_702.clearErrors();
         this.var_1071.clearErrors();
         this.var_875.clearErrors();
         this.var_877.clearErrors();
         this.var_876.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_582,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_641,this.onDoorModePasswordUnselect);
         ...
         this.var_702 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1071 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_875 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_877 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_876 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1073 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1076 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1072 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1069 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_573 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1594 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1333 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1070 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1075 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1596 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1331 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_242 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1077 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2173 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2172 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1332 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1332.mouseThreshold = 0;
         this.var_1332.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1077.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1594.visible = this._inRoom;
         this.var_1596.visible = this._inRoom;
         this.var_2172.visible = this.var_475;
         this.var_2173.visible = !this.var_475;
         if(this.var_475)
         {
         ...
         else
         {
            ...
            this.var_1331.visible = true;
            this.var_1333.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1333.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1070.height = Util.getLowestPoint(this.var_1070) + 4;
         }
         this.var_1332.text = !!this.var_475 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1594.name,this.var_1333.name,this.var_1070.name,this.var_1075.name,this.var_1331.name,this.var_1596.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_702.setText(_loc1_.name);
         this.var_1071.setText(_loc1_.description);
         this.var_876.setText("");
         this.var_1073.setText("");
         ...
         this.setTag(this.var_875,_loc1_.tags[0]);
         this.setTag(this.var_877,_loc1_.tags[1]);
         if(this.var_1076)
         {
            if(_loc1_.allowPets)
            {
               this.var_1076.select();
            }
            else
            {
               this.var_1076.unselect();
            }
         }
         if(this.var_1072)
         {
         ...
         if(this.var_1069)
         {
            ...
            {
               this.var_1069.select();
            }
            else
            {
               this.var_1069.unselect();
            }
         }
         if(this.var_573)
         {
            ...
            {
               this.var_573.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_573.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_702.getText();
         _loc2_.description = this.var_1071.getText();
         ...
         {
            _loc8_ = this.var_876.getText();
            _loc9_ = this.var_1073.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_876.clearErrors();
               this.var_1073.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1076.isSelected;
         _loc2_.allowFoodConsume = this.var_1072.isSelected;
         _loc2_.allowWalkThrough = this.var_1069.isSelected;
         _loc2_.hideWalls = this.var_573.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_875,_loc2_.tags);
         this.addTag(this.var_877,_loc2_.tags);
         this.clearErrors();
