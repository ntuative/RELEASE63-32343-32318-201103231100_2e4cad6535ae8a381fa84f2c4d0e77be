package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_763,RoomWidgetEcotronBoxOpenMessage.const_880,RoomWidgetEcotronBoxOpenedMessage.const_1548];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_763:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_880:
