package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_655,RoomWidgetViralFurniMessage.const_749,RoomWidgetViralFurniMessage.const_166];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_655:
               ...
               break;
            case RoomWidgetViralFurniMessage.const_749:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_463,RoomSessionViralFurniStatusEvent.const_563];
      }
