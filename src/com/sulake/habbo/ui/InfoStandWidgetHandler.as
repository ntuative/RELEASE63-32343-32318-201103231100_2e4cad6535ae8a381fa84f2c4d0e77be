package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_133,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_133,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_603.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_603.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_867);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_181);
         _loc1_.push(RoomWidgetFurniActionMessage.const_449);
         _loc1_.push(RoomWidgetFurniActionMessage.const_554);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_900);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_884);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_434);
         ...
         _loc1_.push(RoomWidgetChangeMottoMessage.const_667);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_537)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_341 || param1.type == RoomWidgetUserActionMessage.const_442 || param1.type == RoomWidgetUserActionMessage.const_559)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_660:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1033,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_760:
               ...
               break;
            case RoomWidgetUserActionMessage.const_867:
            ...
            case RoomWidgetUserActionMessage.const_341:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_900:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_884:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               if(_loc8_.getString(RoomWidgetEnum.const_441) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetEnum.const_441);
               }
               ...
               {
                  _loc26_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_356);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1206);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1050);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_199)
               {
                  _loc14_ = "null";
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_883)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_499);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_116)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_146)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc33_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_691);
                  ...
                  if(!_loc29_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1148;
                  }
                  if(!_loc30_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1011;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1513);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_603.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_603.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
