   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_777,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_796,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_186 != null)
            {
               this.var_186.events.removeEventListener(HabboToolbarEvent.const_68,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_561,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_777,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_796,this.onHabboClubSubscriptionChanged);
         }
         this.var_186 = this._container.toolbar;
         if(this.var_186 != null)
         {
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_561,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this.var_186 != null)
         {
            ...
            this.var_186.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_687);
         _loc1_.push(RoomWidgetDanceMessage.const_771);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_714);
         ...
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1596);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1143);
         _loc1_.push(RoomWidgetToolbarMessage.const_910);
         _loc1_.push(RoomWidgetToolbarMessage.const_878);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_344);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1599);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1118);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_919);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_710);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_846);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1693);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_754);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_824);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_897);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_355);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_710:
               ...
               break;
            case RoomWidgetWaveMessage.const_687:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_771:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_714:
               if(this._inventory != null)
               {
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1125:
                        this._catalog.openCatalogPage(CatalogPageName.const_1716,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1238:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_294);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1576:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_75);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1453:
                        break;
                     default:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1008:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1685:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_1143:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_919:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_910:
               ...
               if(this.var_186)
               {
                  this.var_186.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_878:
               ...
               {
                  this.var_186.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_487,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_344:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_465));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_846:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_347,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_754:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_347,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_824:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_347,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_897:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_591));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_355:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_628));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_561:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_469));
         }
      }
