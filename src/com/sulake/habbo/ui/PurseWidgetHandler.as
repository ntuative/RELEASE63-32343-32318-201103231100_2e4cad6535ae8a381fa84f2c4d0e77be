package com.sulake.habbo.ui
{
   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_825);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_825:
               ...
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_107,_loc2_.getActivityPointsForType(Purse.const_202)));
               break;
            case RoomWidgetOpenCatalogMessage.const_407:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1100:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1476);
                        break;
