package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1760:Map = null;
      
      private var var_1156:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1157:Number = 0.0;
      
      private var var_758:Point = null;
      
      private var var_510:Vector3d;
      
      public function ChatWidgetHandler()
      {
         this.var_1156 = [];
         this.var_510 = new Vector3d();
         super();
      ...
      public function dispose() : void
      {
         ...
         if(this.var_421 != null)
         {
            ...
            {
               _loc2_ = this.var_421.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_794,RoomWidgetChatSelectAvatarMessage.const_834];
      }
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_43) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1044))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_43) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1044))
                              {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_177)
                           {
                              _loc13_ = this.var_311.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_421.getValue(_loc16_) as BitmapData;
                           }
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_177:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_421.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1157 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1157);
            }
            if(this.var_758 == null)
            {
               ...
               this.var_510.y = 0;
               this.var_510.z = 0;
               this.var_758 = _loc4_.getScreenPoint(this.var_510);
               this.var_1157 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_510.x = 0;
            this.var_510.y = 0;
            this.var_510.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_510);
            if(_loc8_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_421)
         {
            _loc2_ = this.var_421.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1156.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1760.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1760.remove(param1);
         if(_loc3_ != null)
         {
