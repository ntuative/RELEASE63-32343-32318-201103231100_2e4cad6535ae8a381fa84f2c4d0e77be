package com.sulake.habbo.ui
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_747 = [];
         this.var_747.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_747.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
         for each(_loc1_ in this.var_747)
         {
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_747)
         {
            return;
         }
         for each(_loc1_ in this.var_747)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_671);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniActionMessage.const_671:
