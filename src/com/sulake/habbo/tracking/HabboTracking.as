package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_969:uint = 11;
      ...
      private var var_207:IHabboFriendList;
      
      private var var_1202:IHabboWindowManager;
      ...
      private var var_265:PerformanceTracker = null;
      
      private var var_639:FramerateTracker = null;
      
      private var var_266:LatencyTracker = null;
      
      private var var_638:LagWarningLogger = null;
      
      private var var_637:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_265 = new PerformanceTracker();
         this.var_639 = new FramerateTracker();
         this.var_266 = new LatencyTracker();
         this.var_638 = new LagWarningLogger();
         this.var_637 = new ToolbarClickTracker(this);
         this.var_1468 = new Array(const_969);
         var _loc4_:int = 0;
         while(_loc4_ < const_969)
         {
            this.var_1468[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1598,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1586,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1720,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_779,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1202)
            {
               this.var_1202.release(new IIDHabboWindowManager());
               this.var_1202 = null;
            }
            if(this.var_295)
            {
            ...
            if(this.var_207)
            {
               ...
               {
                  Component(this.var_207).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_207).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_207).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_207).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_207).events.removeEventListener(HabboFriendListTrackingEvent.const_411,this.onFriendlistTrackingEvent);
               }
               this.var_207.release(new IIDHabboFriendList());
               this.var_207 = null;
            }
            if(this.var_137)
            {
            ...
            if(this.var_186)
            {
               ...
               {
                  this.var_186.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_185)
         {
            if(this.var_266 != null)
            {
               this.var_266.configuration = this.var_185;
            }
            if(this.var_265 != null)
            {
               this.var_265.configuration = this.var_185;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1562);
            if(this.var_185)
            {
               if(this.var_638 != null)
               {
                  this.var_638.configure(this.var_185);
               }
               if(this.var_639 != null)
               {
                  this.var_639.configure(this.var_185);
               }
               if(this.var_637 != null)
               {
                  this.var_637.configure(this.var_185);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_683,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_639,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_67,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_461,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_266 != null)
            {
               this.var_266.communication = this._communication;
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_639)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1621);
         }
         else if(param1.type == HabboHotelViewEvent.const_461)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1676);
         }
         else if(param1.type == HabboHotelViewEvent.const_67)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1675);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_683:
               this.trackLoginStep(HabboLoginTrackingStep.const_1602,String(this._communication.port));
               break;
      ...
      {
         this.var_1202 = IHabboWindowManager(param2);
         if(this.var_1202)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_185)
            {
               if(this.var_185.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1468)
                  {
                  ...
                  if(this.var_265 != null)
                  {
                     _loc4_["null"] = this.var_265.flashVersion;
                     _loc4_["null"] = this.var_265.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1181);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1181,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_207 = param2 as IHabboFriendList;
         Component(this.var_207).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_207).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_207).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_207).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_207).events.addEventListener(HabboFriendListTrackingEvent.const_411,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_411:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_779,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_295.events.addEventListener(AdEvent.const_482,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_186 = param2 as IHabboToolbar;
         this.var_186.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_637)
         {
            this.var_637.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1846;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1846);
         }
         this.var_525 = _loc2_;
         if(this.var_265 != null)
         {
            this.var_265.update(param1,this.var_525);
         }
         if(this.var_266 != null)
         {
            this.var_266.update(param1,this.var_525);
         }
         if(this.var_639 != null)
         {
            this.var_639.trackUpdate(param1,this,this.var_525);
         }
         if(this.var_638 != null)
         {
            this.var_638.update(this.var_525);
         }
      }
   }
}
