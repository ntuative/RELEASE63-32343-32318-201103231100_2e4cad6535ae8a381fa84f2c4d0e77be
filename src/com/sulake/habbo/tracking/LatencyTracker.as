package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         if(this.var_185 == null || this._communication == null || this._connection == null)
         {
            return;
         }
         this.var_1891 = int(this.var_185.getKey("latencytest.interval"));
         this.var_1890 = int(this.var_185.getKey("latencytest.report.index"));
         this.var_2614 = int(this.var_185.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1893 > this.var_1891)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_647.add(this.var_1494,this.var_1893);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1494));
         ++this.var_1494;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_647 == null || this.var_226 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_647.getValue(_loc2_.requestId);
         this.var_647.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_226.push(_loc4_);
         if(this.var_226.length == this.var_1890 && this.var_1890 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1892) > this.var_2614 || this.var_1892 == 0)
            {
               this.var_1892 = _loc9_;
