   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_55)
         {
            ...
            this.var_35.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_561));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_739 = this.var_35.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         ...
         this.var_35.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.MEMENU_ARROW,this.var_739));
      }
