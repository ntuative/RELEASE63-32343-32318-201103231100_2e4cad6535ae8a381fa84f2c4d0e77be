package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1729:uint = 11129827;
      ...
      private var var_1143:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_300;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_503 = param1;
         if(this.var_1730 == this.var_503)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1731 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_753)
         {
            this.var_753 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_753)
            {
               return;
            }
            this._window.content.addChild(this.var_753);
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_835:
            ...
            case ChangeUserNameResultMessageEvent.var_831:
               break;
            case ChangeUserNameResultMessageEvent.var_833:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.long");
               break;
            case ChangeUserNameResultMessageEvent.var_834:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1038 || param1 == ChangeUserNameResultMessageEvent.var_1039)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1143 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1143.render(param3,_loc5_);
         var _loc7_:int = 0;
