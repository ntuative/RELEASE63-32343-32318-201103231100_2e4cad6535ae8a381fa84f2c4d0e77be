package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103231055));
         this.var_186 = param5;
         this.var_113 = new Map();
         this.var_113.add(HabboHelpViewEnum.const_1698,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_174,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_446,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_319,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_241,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_378,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_855,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_255,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_113.add(HabboHelpViewEnum.const_1233,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_113.add(HabboHelpViewEnum.const_1070,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_740,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_479.length == 0 || param1 != this.var_342)
            {
               this.var_479.push(this.var_342);
            }
         }
         this.var_342 = param1;
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_186.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1232:
               this.showUI(HabboHelpViewEnum.const_1070);
               break;
            case CallForHelpResultEnum.const_1108:
               this.showUI(HabboHelpViewEnum.const_1233);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_113.getValue(HabboHelpViewEnum.const_174) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_427));
      }
      ...
      {
         return this.var_113.getValue(this.var_342);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2180 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2182;
         this._window.width = _loc1_.width + this.var_2180;
      }
      ...
      private function method_6(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_479.pop(),false);
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_342 == HabboHelpViewEnum.const_174 || this.var_479.length == 0)
         {
            return;
         }
         if(this.var_341 == null)
         {
            ...
            this.var_341 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_341.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_341.findChildByName("back_text");
            if(_loc5_ != null)
            {
               _loc5_.setParamFlag(WindowParam.const_29);
               _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_6);
            }
         }
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
