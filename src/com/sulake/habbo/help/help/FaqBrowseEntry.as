   ...
   public class FaqBrowseEntry extends HelpViewController
   {
      ...
      override public function render() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            _loc1_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_6);
         }
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(param1 != null)
         {
            this.var_235 = FaqItem(param1);
         }
         if(this.var_235 == null)
         {
            return;
         }
         if(!this.var_235.hasAnswer)
         {
            main.sendMessage(new GetFaqTextMessageComposer(this.var_235.questionId));
            return;
         }
         var _loc3_:FaqCategory = this.var_235.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = this.var_235.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = this.hackHTML(this.var_235.answerText);
         }
         if(_loc3_ != null)
         {
            _loc5_ = _loc3_.getItemByIndex(this.var_235.index + 1);
         }
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || this.var_235 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = this.var_235.category;
         if(_loc2_ == null)
         {
            return null;
         }
         return _loc2_.getItemByIndex(this.var_235.index + 1);
      }
   }
}
