package com.sulake.habbo.help.enum
{
   ...
   public class HabboHelpTutorialEvent extends Event
   {
      ...
      public static const const_561:String = "HHTPNUFWE_LIGHT_CLOTHES_ICON";
      
      public static const const_427:String = "HHTPNUFWE_DONE_GUIDEBOT";
      
      public static const const_465:String = "HHTE_DONE_AVATAR_EDITOR_OPENING";
      
      public static const const_591:String = "HHTE_DONE_AVATAR_EDITOR_CLOSING";
