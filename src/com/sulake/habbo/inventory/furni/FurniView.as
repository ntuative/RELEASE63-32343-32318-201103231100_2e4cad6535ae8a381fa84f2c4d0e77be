package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1754:int = 42;
      
      private const const_1753:int = 120;
      ...
      private var var_812:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_502 = param6;
         this.var_502.events.addEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
         ...
         this.var_418.add(FurniModel.const_51,new FurniGridView(this.var_68,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_502)
            {
               this.var_502.events.removeEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
               this.var_502 = null;
            }
            this.var_611 = null;
            this._disposed = true;
      ...
      public function setViewToState() : void
      {
         ...
         {
            _loc2_ = this.const_1752;
         }
         else
         {
            _loc2_ = this.const_1755;
         }
         if(this.var_2427 == _loc2_)
         {
            return;
         }
         this.var_2427 = _loc2_;
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_340)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_405)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_812 && this.var_812.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1053)
               {
                  _loc21_ = this.var_502.musicController.getSongInfo(_loc5_.extra);
                  if(_loc21_ != null)
                  {
                  ...
                  {
                     this.var_502.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_611.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1053)
               {
                  _loc22_ = this.var_502.musicController.getSongInfo(_loc5_.extra);
                  if(_loc22_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1753)
         {
            _loc3_ = this.const_1753;
         }
         else if(_loc3_ < this.const_1754)
         {
            _loc3_ = this.const_1754;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_63)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_379);
            }
         }
      }
      ...
      {
         if(this.var_611.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_611.indexOf(param1.id as Number) != -1)
            {
               this.var_611.splice(this.var_611.indexOf(param1.id as Number),1);
            }
         }
      }
   }
