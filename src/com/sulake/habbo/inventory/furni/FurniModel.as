package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_379:String = "pets";
      ...
      private var var_1645:Vector.<Array>;
      
      private var var_1646:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_502 = param8;
         this.var_591 = new Timer(const_1283,1);
         ...
         this.var_2273 = XML(_loc10_.content);
         this.clearFurniList();
         this.var_16 = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_502);
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_44)
            {
               ...
               {
                  this.var_1645 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1645;
            }
            else
            {
               if(this.var_1646 == null)
               {
                  this.var_1646 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1646;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_340)
         {
         ...
         else if(param3 == FurniCategory.const_405)
         {
         ...
         if(this.var_909 == null)
         {
            this.var_909 = this._windowManager.buildFromXML(this.var_2273) as IWindowContainer;
         }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_406);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_592.add(const_44,new Array());
         this.var_592.add(const_51,new Array());
         if(this.var_16 != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_405 || _loc3_.category == FurniCategory.const_340 || _loc3_.category == FurniCategory.const_352)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_592.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_592.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_676)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
