package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_384:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_243 = this.var_16.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_384);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_658.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_243.removeGridItem(_loc2_.window);
      ...
      private function selectFirst() : void
      {
         ...
         this.setSelectedGridItem(this.var_658.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_658.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_243.addGridItem(_loc2_.window);
            this.var_658.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_384.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_384 != null)
         {
            this.var_384.setSelected(false);
         }
         this.var_384 = param1;
         if(this.var_384 != null)
         {
            this.var_384.setSelected(true);
         }
