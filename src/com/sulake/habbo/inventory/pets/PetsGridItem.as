package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN:
               this.var_1439.setSelectedGridItem(this);
               this.var_1440 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1440 = false;
                  this.var_1439.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1400.color = !!this._isSelected ? uint(this.const_2044) : uint(this.const_2043);
      }
