package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_53.getValue(InventorySubCategory.const_291));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_53.getValue(InventoryCategory.const_294));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_53.getValue(InventoryCategory.const_402));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_53.getValue(InventoryCategory.const_141));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_53.getValue(InventoryCategory.const_406) as MarketplaceModel;
      }
      ...
      {
         this.var_320 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      {
         this.var_502 = IHabboSoundManager(param2);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_320 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_186 || !this.var_502)
         {
            return;
         }
         this.var_16 = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this.var_16.setToolbar(this.var_186);
         this.var_53 = new Map();
         ...
         this.var_53.add(InventoryCategory.const_406,_loc1_);
         var _loc2_:FurniModel = new FurniModel(this,_loc1_,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._catalog,this.var_502);
         this.var_53.add(InventoryCategory.const_75,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_320);
         this.var_53.add(InventoryCategory.const_294,_loc3_);
         ...
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_320);
         this.var_53.add(InventoryCategory.const_402,_loc5_);
         ...
         this.var_53.add(InventorySubCategory.const_291,_loc6_);
         ...
         this.var_53.add(InventoryCategory.const_141,_loc8_);
         this.var_194 = true;
         if(this.var_2538)
         {
            this.requestData();
