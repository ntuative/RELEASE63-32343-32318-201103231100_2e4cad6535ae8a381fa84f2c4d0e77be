package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1402:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_91 = this.var_599.height;
         this.var_1129 = param5;
         this.var_928 = param6;
         this.var_220 = Math.floor(this.var_1129 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1129,this.var_928);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_220 * this._thumbWidth,this.var_1129),Math.max(this.var_598 * this.var_91,this.var_928),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_220 && this.var_26.height < _loc3_.y * this.var_91)
         {
         ...
         _loc4_ = new Rectangle(0,this.var_91,this._thumbWidth * (this.var_220 - 1),this.var_26.height - this.var_91);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1402.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_928)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_928);
