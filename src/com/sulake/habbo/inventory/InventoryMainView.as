package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_186 != null && this.var_1216)
         {
            this.var_186.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1216 = false;
         }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_790 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_186 != null && this.var_1216)
            {
               this.var_186.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1216 = false;
            }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_186.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1869);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_790 == InventoryCategory.const_141)
            {
               this.toggleCategoryView(InventoryCategory.const_141);
            }
            else if(this.var_790 == InventoryCategory.const_75)
            {
