package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2846:BitmapData;
      
      private const const_2044:int = 8947848;
      
      private const const_2043:int = 13421772;
      
      private const const_1772:Number = 1;
      
      private const const_1771:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2846 = param6;
         this.var_2079 = param7;
         this._items = new Map();
         this.var_2845 = param2;
         this._category = param3;
         this.var_2074 = param8;
         this.var_1310 = param9;
         if(param10 != null)
         {
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2845 == FurniModel.const_44)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1310));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2074);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_676)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1771;
               _loc1_.blend = this.const_1771;
            }
            else
            {
               this._window.blend = this.const_1772;
               _loc1_.blend = this.const_1772;
            }
         }
         if(this.isSelected)
         {
            this.var_1400.color = this.const_2044;
         }
         else
         {
            this.var_1400.color = this.const_2043;
         }
         ...
         if(_loc5_)
         {
            if(this.var_2079 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2846;
               _loc5_.visible = true;
            }
            else
            {
