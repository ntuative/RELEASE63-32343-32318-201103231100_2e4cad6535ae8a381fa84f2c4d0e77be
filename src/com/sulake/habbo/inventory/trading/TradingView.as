package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_999:uint = 4284532064;
      
      private static const const_1000:uint = 2577770;
      ...
      private var var_455:ItemPopupCtrl;
      ...
      private var var_1031:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_455 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_211)
            {
               this.var_211.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_211.stop();
               this.var_211 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1986 = this.createMinimizedWindow();
         }
         if(!this.var_2776)
         {
            return this.var_72;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_72)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_999) : uint(const_1000);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_999) : uint(const_1000);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_211 = new Timer(1000,3);
            this.var_211.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_211.reset();
         this.var_211.repeatCount = 3;
         this.var_211.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_211.currentCount));
         if(this.var_211.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1031)
         {
            this.var_1031.isSelected = false;
            this.var_1031 = null;
         }
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1162)
            {
            ...
            this.var_455.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_533);
            this.var_455.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_455.hideDelayed();
         }
      }
