package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_173:IFrameWindow;
      
      private var var_672:IWindow;
      
      private var var_203:IBorderWindow;
      
      private var var_1173:TagListRenderer;
      ...
      private const const_1784:int = 39;
      
      private const const_1785:int = 7829367;
      
      private const const_1783:int = 16777215;
      
      private const const_2071:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1173 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_998;
         if(param2)
         {
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1173.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2771 > this.const_2071 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2771 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1785;
            if(_loc3_.length >= this.const_1784)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1784 - 1);
            }
         }
      }
      ...
      {
         this.var_173 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_173.center();
         this.var_173.procedure = this.badgesEventProc;
         this.var_173.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_173 && this.var_173.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_672 = null;
         var _loc2_:IItemGridWindow = this.var_173.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_173.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_173.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_672);
               }
               if(_loc3_ <= -1)
               {
                  return;
