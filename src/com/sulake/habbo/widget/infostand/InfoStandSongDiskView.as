package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      public function InfoStandSongDiskView(param1:InfostandWidget, param2:String, param3:IHabboCatalog, param4:IHabboSoundManager)
      {
         ...
         this.var_502 = param4;
         this.var_502.events.addEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceived);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_502)
         {
            this.var_502.events.removeEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceived);
            this.var_502 = null;
         }
      }
      ...
      private function getSongInfoForExtraParam() : ISongInfo
      {
         ...
         var _loc2_:String = _loc1_.substr(RoomWidgetEnum.const_903.length,_loc1_.length);
         return this.var_502.musicController.getSongInfo(int(_loc2_));
      }
