package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2038:uint = 14342874;
      
      private const const_2041:uint = 3815994;
      
      private const const_2031:uint = 2085362;
      
      private const const_2039:uint = 39616;
      
      private const const_2040:uint = 10513106;
      
      private const const_2034:uint = 8734654;
      
      private const const_2030:uint = 9094430;
      
      private const const_2033:uint = 6200576;
      
      private const const_2036:String = "happiness";
      
      private const const_2029:String = "experience";
      
      private const const_2037:String = "energy";
      ...
      {
         if(this.var_54 == null || this.var_203 == null || this.var_69 == null)
         {
            return;
         }
         ...
         this.var_203.height = this.var_54.height + 20;
         this._window.width = Math.max(this.var_203.width,this.var_69.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_203.width < this.var_69.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2036,param1.nutrition,param1.nutritionMax,this.const_2039,this.const_2031);
         this.updateStateElement(this.const_2029,param1.experience,param1.experienceMax,this.const_2034,this.const_2040);
         this.updateStateElement(this.const_2037,param1.energy,param1.energyMax,this.const_2033,this.const_2030);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2032,this.const_2035,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2038);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2041);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1291,_loc7_.width - 2,_loc7_.height - 2 - this.const_1291);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1291);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_54 = this.var_203.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         for each(_loc11_ in _loc10_)
         {
            ...
            _loc11_.addEventListener(WindowEvent.const_46,this.onButtonResized);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_508,this._widget.petData.ownerId);
