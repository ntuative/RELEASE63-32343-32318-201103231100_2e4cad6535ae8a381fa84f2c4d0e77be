package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView
   {
      ...
      public function InfoStandJukeboxView(param1:InfostandWidget, param2:String, param3:IHabboCatalog, param4:IHabboSoundManager)
      {
         ...
         this.var_502 = param4;
         this.var_502.events.addEventListener(NowPlayingEvent.const_831,this.onNowPlayingChanged);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_502)
         {
            this.var_502.events.removeEventListener(NowPlayingEvent.const_831,this.onNowPlayingChanged);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_952 = this.var_203.findChildByTag("catalog");
         if(this.var_952 != null)
         {
            this.var_952.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         var _loc2_:int = this.var_502.musicController.getRoomItemPlaylist().nowPlayingSongId;
         if(_loc2_ != -1)
         {
            _loc6_ = this.var_502.musicController.getSongInfo(_loc2_);
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_54.addListItem(this.var_952);
            }
            this.var_952.visible = param1;
         }
         else
         {
            this.var_54.removeListItem(this.var_952);
         }
      }
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this._widget.mainContainer.visible && this._window.visible)
         {
            if(param1.id != -1)
            {
               _loc2_ = this.var_502.musicController.getSongInfo(param1.id);
               if(_loc2_ != null)
               {
