package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private static const const_1318:int = 5000;
      ...
      private var var_415:Timer = null;
      ...
      {
         return getTimer() - this.var_2357 > const_1318;
      }
      
      public function setLastPasteTime() : void
      {
         this.var_2357 = getTimer();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_140,this.onRoomObjectDeselected);
         ...
         param1.addEventListener(RoomWidgetFloodControlEvent.const_823,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_140,this.onRoomObjectDeselected);
         ...
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_823,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1033:
               _loc2_ = localizations.getKey("widgets.chatinput.mode.whisper",":tell");
               this._visualization.displaySpecialChatMessage(_loc2_,param1.userName);
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1634:
         }
      }
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_872,this._visualization.window);
         if(messageListener != null)
         {
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this.var_738 = this.var_738 - 1;
            this._visualization.showFloodBlocking(this.var_738);
         }
      }
      ...
      {
         this.var_1403 = true;
         this.var_738 = param1.seconds;
         Logger.log("Enabling flood blocking for " + this.var_738 + " seconds");
         if(this.var_415)
         {
            this.var_415.reset();
         }
         ...
         {
            this.var_415 = new Timer(1000,this.var_738);
            this.var_415.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_415.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_415.start();
         if(this._visualization != null)
         {
