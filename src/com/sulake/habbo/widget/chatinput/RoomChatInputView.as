package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1314:int = 11;
      
      private static const const_601:int = 18;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_2323 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_601 + const_947;
         _loc1_.x = const_601;
         _loc1_.y = const_1314;
      }
      ...
      {
         this.var_303 = param1 - (const_601 + const_947);
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_494.length + 1)
            {
