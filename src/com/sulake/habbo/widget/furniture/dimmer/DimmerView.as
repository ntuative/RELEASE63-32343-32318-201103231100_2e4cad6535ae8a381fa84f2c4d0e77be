package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_61,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1262,const_1261,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1523 = _loc2_.light;
         if(this.var_449 != null)
         {
            this.var_449.setValue(this.var_1523);
         }
         this.var_474 = this.colors.indexOf(_loc2_.color);
         if(this.var_660 != null)
         {
            this.var_660.setSelectedColorIndex(this.var_474);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1522 = XML(_loc1_.content);
         return this.var_1522;
      }
