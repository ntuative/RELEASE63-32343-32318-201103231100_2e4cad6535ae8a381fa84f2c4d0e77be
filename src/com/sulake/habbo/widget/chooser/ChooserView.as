package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_2072:uint = 4.282169599E9;
      ...
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_1035)
         {
            return;
         }
         if(this.var_1035 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_1035) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_1035 % 2) ? uint(this.const_1787) : uint(this.const_1788);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_2072;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_2004);
      }
