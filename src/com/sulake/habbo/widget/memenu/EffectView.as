package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2059:int = 1000;
      ...
      {
         super();
         this.var_211 = new Timer(this.const_2059);
         this.var_211.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_211.stop();
            this.var_211.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_211 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_187.isActive)
         {
            ...
            this.var_995.width = _loc2_ * this.var_303;
         }
         else
         {
            this.var_995.width = 0;
            this.var_211.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_996 = this._window.findChildByName("effect_hilite");
            this.var_996.visible = false;
         }
         this.setTimeLeft();
         this.var_995 = this._window.findChildByName("loader_bar");
         if(this.var_995 != null)
         {
            this.var_303 = this.var_995.width;
            this.var_211.start();
            this.onUpdate();
         }
