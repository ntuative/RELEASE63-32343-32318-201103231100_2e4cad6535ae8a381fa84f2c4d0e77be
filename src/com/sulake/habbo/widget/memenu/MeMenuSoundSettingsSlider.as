      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_692 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_692.width,this.var_692.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_692,this.var_692.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1576 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
