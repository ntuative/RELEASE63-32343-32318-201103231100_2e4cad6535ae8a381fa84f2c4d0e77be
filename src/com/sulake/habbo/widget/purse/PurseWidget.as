package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      {
         this.var_2140 = param1.balance;
         if(this.var_16)
         {
            this.var_16.findChildByName("credits").caption = this.var_2140.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_2642 = param1.balance;
         if(this.var_16)
         {
            this.var_16.findChildByName("pixels").caption = this.var_2642.toString();
         }
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1100));
      }
   }
}
