package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1117:int = 1;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_891,0,this.var_412.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         this._startIndex = Math.min(this._startIndex,this.var_133.length - this.var_412.getTabCount());
         this._startIndex = Math.max(0,this._startIndex);
      }
      
      private function getOnlineInfoMsg(param1:Boolean) : Message
      {
         return new Message(Message.const_775,0,this.getOnlineText(param1),Util.getFormattedNow());
      }
