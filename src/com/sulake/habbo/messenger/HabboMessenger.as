package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      {
         var _loc2_:Conversation = this.var_596.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            this.var_596.setSelected(_loc2_);
            this.var_255.openMessenger();
      ...
      {
         this.var_596.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_596.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function playSendSound() : void
      {
         ...
         {
            this.var_502.playSound(HabboSoundTypesEnum.const_1042);
         }
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_185.getKey("url.prefix",_loc2_);
      ...
      {
         this.var_596 = new Conversations(new ConversationsDeps(this));
         this.var_255 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            this.var_186.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         this.var_186.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_255.isMessengerOpen())
            {
               this.var_255.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_735,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1131,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_596.addMessageAndUpdateView(param1);
         if(!this.var_255.isMessengerOpen())
         {
            if(this.var_502 != null)
            {
               this.var_502.playSound(HabboSoundTypesEnum.const_1165);
            }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         this.var_596.addMessageAndUpdateView(_loc3_);
      }
