package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1252:BitmapData = null;
      
      private var var_1251:BitmapData = null;
      ...
      {
         this.var_324 = param2 as IHabboCommunicationManager;
         if(this.var_324 == null)
         {
            return;
         }
         this._connection = this.var_324.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2662 = this._config.getKey("interstitial.enabled","false") == "AvailabilityTimeMessageParser";
         this.var_2664 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2663 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1921 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1921 > 0 && this.var_1922 >= this.var_1921)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1253;
         if(_loc1_ > this.var_2664)
         {
            ++this.var_1922;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1511 = _loc2_.imageUrl;
         this.var_2661 = _loc2_.clickUrl;
         this.var_1253 = getTimer();
         if(this.var_1511 != "")
         {
            _loc3_ = this.var_1511;
            ...
            {
               this.var_228 = new Timer(this.var_2663,1);
            ...
            this.var_228.start();
            _loc4_ = new URLRequest(this.var_1511);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_485,0,0,param1.bitmapData,this.var_2661));
            this.var_1253 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1510 = _loc2_.imageUrl;
         this.var_1923 = _loc2_.clickUrl;
         if(this.var_1510 != "" && this.var_1923 != "")
         {
            _loc3_ = this.var_1510;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1510);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_482,0,0,_loc4_,this.var_1923,this.var_1252,this.var_1251));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1252 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1251 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
