package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_766:ISessionDataManager;
      
      private var var_2500:FriendListLookAndFeel;
      
      private var var_447:FriendListTabs;
      
      private var var_16:FriendListView;
      
      private var var_1799:OpenedToWebPopup;
      ...
      private var var_1800:AvatarSearchResults;
      ...
      {
         this.var_2500 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_102 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1800 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_766)
         {
            this.var_766.release(new IIDSessionDataManager());
            this.var_766 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1799 = new OpenedToWebPopup(this);
         }
         this.var_1799.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_365.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_186.events.dispatchEvent(_loc1_);
      }
      ...
      {
         var _loc2_:IAvatarImage = this.var_1122.createAvatarImage(param1,AvatarScaleType.const_88,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_185.getKey("client.minimail.embed.enabled");
         return _loc1_ == "AvailabilityTimeMessageParser";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_185.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_186 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_931 = param2 as IHabboNotifications;
      ...
      {
         this.var_766 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_365 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_102.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_1037,this.getText("friendlist.friends")));
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_359,this.getText("friendlist.friends.offlinecaption")));
         ...
         this.var_186.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_102.findCategory(FriendCategory.const_359);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_411));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function registerListeners() : void
      {
         ...
         this._communication.addHabboConnectionMessageEvent(new NewBuddyRequestEvent(this.method_10));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_365.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_365.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_447.findTab(FriendListTab.const_98).setNewMessageArrived(true);
      ...
      private function method_10(param1:IMessageEvent) : void
      {
         ...
         this.var_365.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_447.findTab(FriendListTab.const_98);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1800.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_447.findTab(FriendListTab.const_98);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_766 || !this.var_365)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_766.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_45))
         {
            _loc2_ = this.var_365.vipLimit;
         }
         else if(this.var_766.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_365.clubLimit;
         }
         if(_loc2_ > this.var_365.limit)
         {
            this.var_365.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_161) as IBitmapWrapperWindow;
