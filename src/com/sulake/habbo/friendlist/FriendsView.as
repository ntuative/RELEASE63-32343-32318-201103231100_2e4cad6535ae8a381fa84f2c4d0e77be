package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2001:String = "bg";
      ...
      private var var_2555:IContainerButtonWindow;
      
      private var var_2556:IContainerButtonWindow;
      
      private var var_2557:IContainerButtonWindow;
      
      private var var_61:IItemListWindow;
      
      private var var_455:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_455 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2554 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2555 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2556 = this.initButton("room_invite",this.onInviteButtonClick,param1);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_93,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2554,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2555,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2556,this.isEnableInviteButton(_loc1_));
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_455.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_455.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_455.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_232)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_232 && _loc4_.online)
            {
