package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_689.addEventListener(WindowKeyboardEvent.const_185,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_61.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_382,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_455.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_455.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
