package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1751:String = "noconvinfo";
      
      private static const const_1750:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1382:FriendListTabsView;
      ...
      private var var_1381:ITextWindow;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1382 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_1022 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_275 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1382.prepare(this.var_1022);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1082,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1111,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_715,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_861,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_715,false);
         ...
         this.var_1381 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1381.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1651 == -1 ? 0 : int(this.var_17.height - this.var_1651);
         var _loc4_:int = this.var_1653 == -1 ? 0 : int(this.var_17.width - this.var_1653);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_275.y = Util.getLowestPoint(this.var_17.content);
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1245,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_715,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1082,false);
         ...
         this.var_1651 = this.var_17.height;
         this.var_1653 = this.var_17.width;
