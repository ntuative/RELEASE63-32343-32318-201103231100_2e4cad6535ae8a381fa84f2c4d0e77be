package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1774:String = "no_reqs_info";
      ...
      private var var_1962:IContainerButtonWindow;
      ...
      {
         this.var_1962 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1961 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1961.procedure = this.onDismissAllButtonClick;
         this.var_1962.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function method_3(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_302,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_394 && _loc4_.state != FriendRequest.const_349)
            {
               _loc4_.state = FriendRequest.const_349;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_302,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1962,_loc1_);
         this.setEnabled(this.var_1961,_loc1_);
      }
