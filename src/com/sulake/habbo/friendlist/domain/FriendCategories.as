package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategories
   {
      ...
      {
         var _loc2_:int = !!param1.online ? int(param1.categoryId) : int(FriendCategory.const_359);
      ...
      private function updateCategories(param1:Array) : void
      {
         ...
         this.findCategory(FriendCategory.const_359).received = true;
         this.findCategory(FriendCategory.const_1037).received = true;
