package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2199 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = "";
            _loc3_ = this.var_185.getKey("url.prefix",_loc3_);
            _loc3_ = _loc3_.replace("http://","");
            _loc3_ = _loc3_.replace("https://","");
            super.setPredefinedUrl(_loc3_);
            if(!this.var_1613)
            {
               if("false" == this.var_185.getKey("use.default.localizations","false"))
               {
                  _loc5_ = this.var_185.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_168,this.onLocalizationLoaded);
                  super.loadLocalizationFromURL(_loc5_);
               }
            }
            _loc4_ = 1;
            while(this.var_185.keyExists("localization." + _loc4_))
            {
               _loc6_ = this.var_185.getKey("localization." + _loc4_,"");
               _loc7_ = this.var_185.getKey("localization." + _loc4_ + ".name","");
               _loc8_ = this.var_185.getKey("localization." + _loc4_ + ".url","");
      ...
      public function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(this.var_185.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_185.getKey("external.override.texts.txt");
      ...
      {
         return this.var_2199[Math.max(0,param1 - 1)];
      }
   }
}
