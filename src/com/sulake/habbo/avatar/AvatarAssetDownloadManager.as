package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_416:AssetLoaderStruct;
      
      private var var_939:Timer;
      ...
      private const const_2048:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_416 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_939 = new Timer(this.const_2048,1);
         this.var_939.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_416)
         {
            this.var_416.addEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_416.addEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_416)
         {
            this.var_416.removeEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_416.removeEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         else
         {
            ...
            if(this.var_1414.indexOf("?") > 0)
            {
               _loc2_ = this.var_1414 + "&retry=" + this.var_938;
            }
            else
            {
               _loc2_ = this.var_1414 + "?retry=" + this.var_938;
            ...
            this.var_416 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2426,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1724)
         {
            this.var_1140.push([param1,param2]);
            return;
         }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_937)
         {
            _loc7_ = true;
            _loc4_ = this.var_937[_loc3_];
      ...
      {
         var _loc1_:* = null;
         while(this.var_751.length > 0 && this.var_750.length < this.const_1655)
         {
            _loc1_ = this.var_751[0];
            _loc1_.startDownloading();
            this.var_750.push(this.var_751.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_751.indexOf(param1) == -1 && this.var_750.indexOf(param1) == -1)
         {
