package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1287:IWindowContainer;
      
      public static var var_1552:IWindowContainer;
      ...
      private var var_522:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1181 = [];
         this.var_1356 = [AvatarEditorFigureCategory.const_799,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_265,AvatarEditorFigureCategory.const_833,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_101];
         super();
         ...
         if(var_1287 == null)
         {
            ...
            var_1287 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1552 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1552 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_427 = new Timer(1000);
         this.var_427.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1356;
         }
         for each(_loc6_ in param4)
         {
            this.var_1181.push(_loc6_);
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1356);
         }
         if(param1.length != this.var_1181.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2531 = this.canChangeOutfit();
            this.var_427.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_522 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_522.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_522.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1181.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_522.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_522.numSelectables)
               {
                  this.var_522.getSelectableAt(_loc6_).x = this.var_522.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1356;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_43) && (this.var_1821 == AvatarEditorSideCategory.const_101 || this.var_2532))
         {
      ...
      {
         if(this.var_1821 == AvatarEditorSideCategory.const_101)
         {
            this.var_2532 = false;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_342 = param1;
         this.var_522.setSelected(this.var_522.getSelectableByName(param1));
      ...
      public function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_63)
         {
            ...
            {
               this._controller.method_4(_loc3_);
            }
         }
