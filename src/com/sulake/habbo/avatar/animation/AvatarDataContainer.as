package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1601 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2178 = parseInt(_loc2_,16);
         this.var_2177 = parseInt(_loc3_,16);
         ...
         this.var_898 = new ColorTransform(this.var_1641,this.var_1640,this.var_1639,this._alphaMultiplier);
         this.var_1078 = this.generatePaletteMapForGrayscale(this.var_2177,this.var_2178);
      }
      ...
      {
         return this.var_1078.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1078.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1078.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1078.getValue("alphas") as Array;
      }
