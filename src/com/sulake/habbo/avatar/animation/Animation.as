package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1582 = String(param2.@desc);
         }
         else
         {
            this.var_1582 = this._id;
         }
         if(param2.hasOwnProperty("sprite"))
         {
            for each(_loc3_ in param2.sprite)
            {
               this.var_1391.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1678 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1393.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1677 = new DirectionDataContainer(param2.direction[0]);
         }
         ...
         if(param2.hasOwnProperty("remove"))
         {
            ...
            {
               this.var_1392.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_731.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("IRoomObjectFactory"))
         {
            this._overrideFrames = new Map();
            this.var_595 = new Map();
            for each(_loc7_ in param2.IRoomObjectFactory)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@IRoomObjectFactory;
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param2))
         {
            ...
            {
               for each(_loc5_ in this.var_731)
               {
      ...
      {
         return this.var_1392 != null;
      }
      
      public function hasAddData() : Boolean
      {
         return this.var_731 != null;
      }
