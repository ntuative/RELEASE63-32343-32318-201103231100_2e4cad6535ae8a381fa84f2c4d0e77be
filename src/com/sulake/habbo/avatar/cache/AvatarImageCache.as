package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1741:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1492:IAvatarImage;
      ...
      private var var_2126:ByteArray;
      
      private var var_2125:ImageData;
      
      private var var_1034:PaletteMap;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_238.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_238.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_238.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_238.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_238.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_238.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_687 == GeometryType.const_1171 && param1 == GeometryType.const_1091 || this.var_687 == GeometryType.const_1091 && param1 == GeometryType.const_1171)
         {
            this.var_687 = param1;
            this.var_86 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_238.add(param1,this._bodyPartCache);
         }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1492.getFigure(),_loc5_,this.var_687,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_441 == null)
         {
            ...
            this.var_441 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_337);
            if(this.var_441 == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_238.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_238.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_86)
         {
            this.var_86 = this._structure.getCanvas(this._scale,this.var_687);
            if(!this.var_86)
            {
               return null;
            }
            this.var_2124 = new Point(0,this.var_86.height - int(this.var_86.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1505[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_733 || _loc10_ == AvatarAction.const_371;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1314 = this.var_112.bodyPartId;
               this.var_178 = this.var_112.partType;
               this.var_1573 = this.var_112.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_112.flippedPartType != this.var_178)
                     {
                        this.var_178 = this.var_112.flippedPartType;
                     }
                  }
               }
               this.var_1313 = this._scale + "_" + this.var_112.action.assetPartDefinition + "_" + this.var_178 + "_" + this.var_1573 + "_" + _loc5_ + "_" + this._frame;
               this.var_404 = this._assets.getAssetByName(this.var_1313) as BitmapDataAsset;
               if(this.var_404 == null)
               {
                  this.var_1313 = this._scale + "_std_" + this.var_178 + "_" + this.var_1573 + "_" + _loc5_ + "_0";
                  this.var_404 = this._assets.getAssetByName(this.var_1313) as BitmapDataAsset;
               }
               if(!(!this.var_404 || !this.var_404.content))
               {
                  ...
                  {
                     this.var_1034 = this._structure.renderManager.paletteManager.getPalette(this.var_112.paletteMapId);
                     if(this.var_1034 != null)
                     {
                        this.var_853 = this.var_404.content as BitmapData;
                        this.var_179 = new BitmapData(this.var_853.width,this.var_853.height);
                        this.var_2126 = this.var_1034.colorize(this.var_853.getPixels(this.var_853.rect));
                        this.var_179.setPixels(this.var_179.rect,this.var_2126);
                     }
                     else
                     {
                        this.var_179 = (this.var_404.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1314 == AvatarBodyPartType.const_265 || this.var_1314 == AvatarBodyPartType.const_1465 || this.var_1314 == AvatarBodyPartType.const_1479) && this.var_112.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_179.colorTransform(this.var_179.rect,this.var_112.color.colorTransform);
                  }
                  if(this.var_112.isBlendable)
                  {
                     this.var_179.colorTransform(this.var_179.rect,this.var_112.blendTransform);
                  }
                  this.var_852 = this.var_404.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_56)
                     {
                  ...
                  this.var_2125 = new ImageData(this.var_179,this.var_852,_loc7_);
                  this.var_851.push(this.var_2125);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_851,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2124.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_56)
            {
         ...
         _loc8_ = this.var_851.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_851.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
