package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(this.var_16 != null)
         {
            this.var_562 = this.var_16.findChildByName("part_thumbs") as IItemGridWindow;
            this.var_469 = new Array();
            this.var_469.push(this.var_16.findChildByName("palette0") as IItemGridWindow);
            this.var_469.push(this.var_16.findChildByName("palette1") as IItemGridWindow);
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_68.getCategoryData(this.var_1309);
         if(!_loc1_)
         {
            return;
         }
         ...
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               this.var_562.addGridItem(_loc2_.view);
      ...
      {
         var _loc3_:IWindow = this.var_562.getGridItemAt(param1);
         if(!_loc3_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_562.getGridItemIndex(param1.window);
            this.var_68.selectPart(this.var_1309,_loc3_);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN)
         {
            ...
            while(_loc7_ < this.const_1257)
            {
               if(this.var_469.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     this.var_68.selectColor(this.var_1309,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
