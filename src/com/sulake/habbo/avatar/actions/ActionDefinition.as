package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2463 = parseInt(param1.@precedence);
         this.var_2466 = String(param1.@activepartset);
         this.var_2465 = String(param1.@assetpartdefinition);
         this.var_2469 = String(param1.@lay);
         this.var_687 = String(param1.@geometrytype);
         this.var_2468 = Boolean(parseInt(param1.@main));
         this.var_2470 = Boolean(parseInt(param1.@name_4));
         this.var_2464 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "AvailabilityTimeMessageParser"));
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1774[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2467;
         }
         return _loc2_;
      }
