   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_204,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_236,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_222,_windowManager,_assetLibrary);
         ...
         if(var_68 && var_145 == "")
         {
            var_68.switchCategory(FigureData.const_204);
         }
      }
