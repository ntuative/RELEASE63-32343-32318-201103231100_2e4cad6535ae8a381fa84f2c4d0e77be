package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1322:String = "Default";
      
      private static const const_1320:int = 2;
      
      private static const const_1321:String = AvatarSetType.const_36;
      ...
      protected var var_745:Boolean;
      
      protected var var_760:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_238:AvatarImageCache;
      
      protected var var_606:AvatarFigureContainer;
      ...
      private var var_2444:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_606 = param3;
         this.var_238 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1321,const_1320);
         this.var_330 = new Array();
         this.var_936 = new ActiveActionData(AvatarAction.const_400);
         this.var_936.definition = this._structure.getActionDefinition(const_1322);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_745)
         {
            ...
            if(this.var_756)
            {
               for each(_loc2_ in this.var_756)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_606,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1722;
         if(param2 < AvatarDirectionAngle.const_1222)
         {
            param2 = AvatarDirectionAngle.const_298 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_298)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_618,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_259.length == 1 && this.var_89 == this.var_1604)
         {
            return this.var_89 + this.var_507 + this.var_618 % 4;
         }
         if(this.var_259.length == 2)
         {
            for each(_loc1_ in this.var_259)
            {
               ...
               {
                  return this.var_89 + this.var_507 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_618 % 11;
                  return this.var_89 + "_" + this.var_1604 + this.var_507 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2443 || param2 != this.var_2444 || param1 != this.var_2442)
         {
            this.var_2443 = param3;
            this.var_2444 = param2;
            this.var_2442 = param1;
            this.var_1746 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1299 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1299)
            {
               this.var_46.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_283.definition.geometryType,this.var_89);
         this.var_46.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_618);
         ...
         if(this.var_557 != null)
         {
            if(this.var_557.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc13_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_557.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_283.definition.geometryType,this.var_89);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_618);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_330.push(new ActiveActionData(param1,param2,this.var_618));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_283 = this.var_936;
         this.var_283.definition = this.var_936.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_507 = "";
         this.var_259 = this._structure.sortActions(this.var_330);
         if(this.var_259 == null)
         {
         ...
         {
            this.var_760 = this._structure.getCanvasOffsets(this.var_259,this._scale,this.var_89);
            ...
            if(this.var_1422 != this.var_507)
            {
               _loc1_ = true;
               this.var_1422 = this.var_507;
            }
         }
         this.var_1413 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_259)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_885 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_305 || _loc1_.actionType == AvatarAction.const_271 || _loc1_.actionType == AvatarAction.const_371)
               {
                  this.var_885 = true;
               }
            }
