package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1589:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1322 = param3 + this.var_867 + ".swf";
         this.var_1322 = this.var_1322.replace("%revision%",this._revision);
      ...
      {
         this._state = var_1589;
         var _loc1_:URLRequest = new URLRequest(this.var_1322);
