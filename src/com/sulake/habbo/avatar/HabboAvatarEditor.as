package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1256:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1255:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1317:IHabboAvatarEditorDataSaver = null;
      
      private var var_1580:Boolean = false;
      
      private const const_1257:int = 2;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_194)
         {
            ...
            this.var_568["null"] = new FigureData(this);
            this.var_568["null"] = new FigureData(this);
            _loc2_ = this.var_568["null"];
            _loc3_ = this.var_568["null"];
            _loc2_.loadAvatarData(const_1256,FigureData.const_78);
            _loc3_.loadAvatarData(const_1255,FigureData.FEMALE);
            this.var_102 = new Map();
            this.var_472 = new Map();
            this.var_102.add(AvatarEditorFigureCategory.const_799,new BodyModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_265,new TorsoModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_833,new LegsModel(this));
            ...
            this.var_472.add(AvatarEditorSideCategory.const_101,new WardrobeModel(this));
            this.var_472.add(AvatarEditorSideCategory.const_455,new ClubPromoModel(this));
            this.var_194 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_568[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_239 == null)
            {
               this.var_239 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_61,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_239.addChild(this.var_16.window);
               if(param5)
               {
                  this.var_239.center();
               }
         ...
         {
            this.method_4(param3[0]);
         }
         else
         {
            this.method_4(AvatarEditorFigureCategory.const_799);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_472.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         this.var_861 = this.var_473.getFigureData(AvatarType.const_113);
      ...
      {
         return this.var_568[this.var_933];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1317 != null)
         {
            ...
            this.var_1317.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1581;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1062 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1257)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1552.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1287.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1463)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1062 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1287.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1062 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_472.getValue(AvatarEditorSideCategory.const_101);
      }
