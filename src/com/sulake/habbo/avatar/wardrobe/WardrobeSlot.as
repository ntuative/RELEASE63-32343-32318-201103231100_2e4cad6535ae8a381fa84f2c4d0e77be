package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_606 && this.var_1409)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_88,this.var_933,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_36,parseInt(FigureData.const_839));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1409 && this.var_606 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_606 = this._controller.figureData.getFigureString();
               this.var_933 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1715,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_606)
               {
                  this._controller.loadAvatarInEditor(this.var_606,this.var_933,this._controller.clubMemberLevel);
               }
         }
      }
