package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1427:uint = 7645971;
      
      private var var_1771:uint = 6710886;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1772.setTime(param1.endDateTimeStamp);
         this.var_808 = param1.localizationCode;
         this.var_2460 = param1.questBadgeAchievementTypeId;
         this.updateView();
      }
      ...
      private function createView() : void
      {
         switch(this.var_396)
         {
            case QuestStatusEnum.const_47:
               ...
               break;
            case QuestStatusEnum.const_368:
            ...
            case QuestStatusEnum.const_178:
               ...
               break;
            case QuestStatusEnum.const_674:
         ...
         if(_loc1_ != null)
         {
            this.var_1427 = _loc1_.color;
         }
         var _loc2_:IWindow = this.var_16.findChildByTag("SELECTION_BORDER");
         if(_loc2_ != null)
         {
            this.var_1771 = _loc2_.color;
            this.var_203 = _loc2_;
         }
         else
         {
            this.var_203 = this.var_16;
         }
         this.var_203.color = this.var_1427;
      }
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_63.code,this.var_808].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this._selected)
            {
               this.var_203.color = this.var_1771;
            }
         }
