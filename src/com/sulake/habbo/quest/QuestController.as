package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      public function questAccepted(param1:String, param2:QuestMessageData) : void
      {
         ...
         if(this.var_263 != null && this.var_263.quest.id == param2.id)
         {
      ...
      public function questCompleted(param1:String, param2:QuestMessageData) : void
      {
         ...
         if(this.var_263 != null && this.var_263.quest.id == param2.id && this.var_106 != null)
         {
      ...
      public function openCampaign(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_588 != MODE_TABS)
         {
            this.var_588 = MODE_NO_TABS;
         }
         this.detachCampaign();
         _loc4_ = this.var_107[param1];
         if(!_loc4_)
      ...
      private function attachCampaign() : void
      {
         ...
         this._selectedCampaign.attachTo(this.var_1176);
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1176 = this._window.findChildByName("content") as IWindowContainer;
      }
      
      public function initializeReminderTimer() : void
      {
         if(this.var_65.configuration.getKey("questing.reminder.enabled","") != "AvailabilityTimeMessageParser")
         {
         ...
         this.var_1175 = new Timer(_loc1_ * 1000);
         this.var_1175.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         if(this.var_106 != null && this.var_106.visible)
         {
            return;
         }
      ...
      private function showQuestReminder(param1:QuestCampaign, param2:Quest) : void
      {
         ...
         if(this.var_106 != null)
         {
            _loc3_ = this.var_106.rectangle;
            this.var_106.dispose();
            this.var_106 = null;
         }
         this.var_106 = IWindowContainer(this.var_65.getXmlWindow("QuestReminder"));
         this.var_106.findChildByTag("close").procedure = this.onReminderWindowClose;
         if(_loc3_ != null)
         {
            this.var_106.x = _loc3_.x;
            this.var_106.y = _loc3_.y;
         }
         else
         {
            this.var_106.center();
         }
         var _loc4_:IWindowContainer = IWindowContainer(this.var_106.findChildByName("quest.container"));
         ...
         this.var_263 = new QuestView(param1,param2,true);
         _loc4_.addChild(this.var_263.view);
         this.var_263.init();
         this.var_106.height = param2.type == "FIND_STUFF" ? 453 : 390;
      ...
      {
         return param1 == QuestStatusEnum.const_47 || param1 == QuestStatusEnum.const_368;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_107.getKeys())
         {
            ...
            if(!_loc2_)
            {
               ...
               _loc2_ = this.var_65.windowManager.createWindow("tab_" + _loc4_,"${" + _loc6_ + "}",WindowType.const_541) as ITabButtonWindow;
               if(_loc3_.expired)
               {
