package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private const const_2001:String = "achievement_bg_001";
      ...
      {
         this.var_189 = IFrameWindow(this.var_63.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_189.findChildByName("description_txt").caption = this.var_63.controller.questEngine.localization.getKey(_loc5_);
         ...
         this.var_189.findChildByName("reward_txt").caption = this.var_63.controller.questEngine.localization.getKey(_loc6_);
      ...
      private function onRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!this.var_745 && this.var_189 && _loc2_)
         {
