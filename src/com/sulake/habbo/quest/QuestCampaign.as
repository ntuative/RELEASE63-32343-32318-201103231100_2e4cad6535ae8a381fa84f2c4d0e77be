package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_298:IItemListWindow;
      ...
      private var var_1109:IRegionWindow;
      
      private var var_137:QuestHelp;
      ...
      public function QuestCampaign(param1:QuestController, param2:String)
      {
         ...
         this.var_137 = new QuestHelp(this);
      }
      ...
      private function reset() : void
      {
         ...
         if(this.var_297)
         {
            ...
            {
               this.var_298.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_297 = null;
            this.var_298.destroyListItems();
            this.var_298.removeListItems();
         }
         this.var_488 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_159 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1379 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_298 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.code + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1379.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1379.findChildByName("currency.amount").caption = "${quest_" + this.var_1647 + ".currency}";
         ...
         this.var_1109 = this._window.findChildByName("help.container") as IRegionWindow;
         if(this.var_1109)
         {
            this.var_1109.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1109.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1109.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
         if(this.var_727)
         {
      ...
      public function attachTo(param1:IWindowContainer) : void
      {
         ...
         if(this.var_159)
         {
            this.var_159.height = this._window.height - this.var_159.y * 2;
            if(this.var_201)
            {
               this.var_201.view.height = this.var_159.height;
            }
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_137)
         {
            this.var_159.addChild(this.var_137.view);
         }
         if(this.var_159)
         {
            this.var_159.height = this._window.height - this.var_159.y * 2;
            if(this.var_137.view)
            {
               this.var_137.view.height = this.var_159.height;
            }
         }
      }
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1379.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_297.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_297)
         {
            this.var_298.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_47 || _loc4_.status == QuestStatusEnum.const_368))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_298.maxScrollV > 0)
            {
               this.var_298.scrollV = _loc3_.view.y / this.var_298.maxScrollV;
            }
         }
         else if(this.var_297.length > 0)
         {
            this.activateListItem(this.var_297[0]);
         }
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_159.addChild(this.var_201.view);
         this.var_201.init();
         this.var_159.height = this._window.height - this.var_159.y * 2;
         this.var_201.view.height = this.var_159.height;
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_489.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_489)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_489.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_489.splice(_loc4_,1);
            }
         }
      }
      ...
      {
         return this.var_489 != null && this.var_489.length > 0;
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this.var_297[_loc3_] = _loc5_;
            _loc6_ = this.var_298.getListItemIndex(_loc2_.view);
            this.var_298.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_298.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_298.addListItem(_loc5_.view);
            }
