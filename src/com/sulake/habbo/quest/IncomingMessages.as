package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1726:IAlertDialog;
      ...
      private function method_16(param1:IAlertDialog, param2:Event) : void
      {
         param1.dispose();
      }
      ...
      private function setQuestingEnabled(param1:Boolean) : void
      {
         ...
         if(this.var_65.toolbar != null)
         {
            ...
            {
               this.var_65.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
