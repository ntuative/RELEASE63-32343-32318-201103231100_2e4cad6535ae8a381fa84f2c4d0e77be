package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_420:uint = 3;
      
      private static const const_1361:uint = 1;
      ...
      private var var_1471:IEventDispatcher;
      
      private var var_1209:Boolean = false;
      
      private var var_1847:ProfilerOutput;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_972 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_973 = new WindowRenderer(this.var_972);
         this._windowContextArray = new Array(const_420);
         ...
         this.var_239 = this._windowContextArray[const_1361];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1847)
            {
               this.var_1847 = new ProfilerOutput(context,this,this.var_973);
            }
            this.var_1847.profiler = _loc3_;
            this.var_1469 = new ProfilerAgentTask("Update","Event processing");
      ...
      {
         return this.var_972.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_239.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1471.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_420 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1471.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_420)
         {
         ...
         this.var_1471.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1480,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1443,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1441,new Date().getTime().toString());
