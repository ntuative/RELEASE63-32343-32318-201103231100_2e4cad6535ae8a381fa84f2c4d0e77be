package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_526:UserInfoCtrl;
      
      private var var_1211:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_526 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
         this.var_1211 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
         this.var_526.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1211.load(_loc4_,this.var_167.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_67 != null && this.var_67.issueManager != null && this.var_167 != null)
         {
            this.var_67.issueManager.removeHandler(this.var_167.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_167.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_167.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_167.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.releaseBundle(this.var_167.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_67,WindowTracker.const_1153,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_526 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
            this.var_526.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
