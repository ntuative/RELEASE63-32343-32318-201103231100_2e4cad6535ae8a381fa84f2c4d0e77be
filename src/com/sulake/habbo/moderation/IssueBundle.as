package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_741:IssueMessageData = null;
      
      private var var_740:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2375 = param2.pickerUserId;
         this.var_2376 = param2.pickerUserName;
         this.var_1540 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1134 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1133;
         }
         if(this.var_741 == null || param1.timeStamp < this.var_741.timeStamp)
         {
            this.var_741 = param1;
         }
         if(this.var_740 == null || param1.priority > this.var_740.timeStamp)
         {
            this.var_740 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_740;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_741;
         if(_loc2_ == null)
         {
