package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1448:ICheckBoxWindow;
      
      private var var_1447:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_340));
      ...
      public function populate() : void
      {
         ...
         this.var_1052 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1052);
         this.var_1052.procedure = this.onSelectTemplate;
         this.var_954 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1448 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1447 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_705,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_645 || this.var_519.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_954.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1577,_loc2_,this.var_519.text,"",""));
         if(this.var_1448.isSelected || this.var_1447.isSelected || this.var_954.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1448.isSelected,this.var_1447.isSelected,this.var_954.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1703);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1561);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1052.selection];
         if(_loc3_ != null)
         {
            this.var_645 = false;
