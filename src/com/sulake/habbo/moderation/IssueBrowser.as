package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2050:String = "my_issues";
      
      private const const_2052:String = "open_issues";
      
      private const const_2051:String = "picked_issues";
      ...
      private var var_1750:IIssueBrowserView;
      
      private var var_1749:IIssueBrowserView;
      
      private var var_1751:PickedIssuesView;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2050:
               if(this.var_1750 == null)
               {
                  this.var_1750 = new MyIssuesView(this.issueManager,this,this.var_260.container);
               }
               return this.var_1750;
            case this.const_2052:
               if(this.var_1749 == null)
               {
                  this.var_1749 = new OpenIssuesView(this.issueManager,this,this.var_260.container);
               }
               return this.var_1749;
            case this.const_2051:
               if(this.var_1751 == null)
               {
                  this.var_1751 = new PickedIssuesView(this.issueManager,this,this.var_260.container);
               }
