package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1697:int = 200;
      ...
      {
         this.var_737 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1466;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_737.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_927.length < var_1697)
         {
            ...
            param1.width = this.var_737.width;
            param1.height = this.var_737.height;
            var_927.push(param1);
         }
         else
         {
