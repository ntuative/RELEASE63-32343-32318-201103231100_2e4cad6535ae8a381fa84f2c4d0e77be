package com.sulake.habbo.moderation
{
   ...
   public class ModerationManager extends Component implements IHabboModeration
   {
      ...
      private var var_2516:ModerationMessageHandler;
      
      private var _issueManager:IssueManager;
      
      private var var_957:StartPanelCtrl;
      
      private var var_2519:WindowTracker;
      
      private var var_2518:ModeratorInitData;
      ...
      public function ModerationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_957 = new StartPanelCtrl(this);
         this.var_2519 = new WindowTracker();
      }
      ...
      public function userSelected(param1:int, param2:String) : void
      {
         ...
         this.var_957.userSelected(param1,param2);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            this.var_2516 = new ModerationMessageHandler(this);
         }
      }
