package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1586:int = 1000;
      
      private static var var_862:Array = [];
      ...
      {
         this.var_695 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_696 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         this.var_496 = new Timer(1000,1);
         ...
         this.var_35.connection.send(this.var_1583);
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_862.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1584[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1321.getValue(param2.chatterName))
            {
               this.var_1321.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1321.getValue(_loc2_);
