package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      public function RoomObject(param1:int, param2:int, param3:String)
      {
         ...
         this.var_623 = new Array(param2);
         var _loc4_:Number = param2 - 1;
         while(_loc4_ >= 0)
         {
            this.var_623[_loc4_] = 0;
            _loc4_--;
         }
         this._type = param3;
      ...
      {
         this.var_1777.assign(this.var_92);
         return this.var_1777;
      }
      
      public function getDirection() : IVector3d
      {
         this.var_1778.assign(this.var_378);
      ...
      {
         if(param1 >= 0 && param1 < this.var_623.length)
         {
            return this.var_623[param1];
         }
         return -1;
      }
      ...
      public function setDirection(param1:IVector3d) : void
      {
         ...
         if(this.var_378.x != param1.x || this.var_378.y != param1.y || this.var_378.z != param1.z)
         {
            this.var_378.x = (param1.x % 360 + 360) % 360;
            this.var_378.y = (param1.y % 360 + 360) % 360;
            this.var_378.z = (param1.z % 360 + 360) % 360;
            ++this._updateID;
         }
      }
      ...
      {
         if(param2 >= 0 && param2 < this.var_623.length)
         {
            if(this.var_623[param2] != param1)
            {
               this.var_623[param2] = param1;
               ++this._updateID;
            }
            return true;
         }
