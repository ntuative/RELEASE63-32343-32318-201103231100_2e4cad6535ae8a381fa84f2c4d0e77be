package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2907:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_615 = [];
         this.var_570 = [];
         events.addEventListener(RoomContentLoadedEvent.const_401,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_495,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_778,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_616 == null || this.var_506 == null)
         {
            return;
         }
         this._state = const_1717;
         if(this.var_1150 != null)
         {
            _loc1_ = this.var_1150;
            this.var_1150 = null;
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_728)
         {
            return;
         }
         if(this.var_57 == null)
         {
            this._state = const_728;
            return;
         }
         if(this.var_57.getGraphicAssetCollection(param1) != null)
         {
