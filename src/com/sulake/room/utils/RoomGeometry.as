package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1088:Number = 32;
      ...
      private var var_1884:Vector3d;
      
      private var var_530:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1220:Vector3d;
      ...
      private var var_1882:Number = 1.0;
      
      private var var_1883:Number = 1.0;
      
      private var var_1885:Number = 1.0;
      ...
      private var var_2879:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1220 = new Vector3d();
         this.var_1882 = 1;
         this.var_1883 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1885 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_1884.assign(this.var_152);
         return this.var_1884;
      }
      
      public function get location() : IVector3d
      {
         this.var_530.assign(this.var_92);
         this.var_530.x *= this.var_437;
         this.var_530.y *= this.var_439;
         this.var_530.z *= this.var_438;
         return this.var_530;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_378);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_437 != param1 * this.var_1882)
         {
            this.var_437 = param1 * this.var_1882;
            ++this.var_169;
         }
      }
      ...
      {
         if(this.var_439 != param1 * this.var_1883)
         {
            this.var_439 = param1 * this.var_1883;
            ++this.var_169;
         }
      }
      ...
      {
         if(this.var_438 != param1 * this.var_1885)
         {
            this.var_438 = param1 * this.var_1885;
            ++this.var_169;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_92.x /= this.var_437;
         this.var_92.y /= this.var_439;
         this.var_92.z /= this.var_438;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_378.x;
         var _loc3_:Number = this.var_378.y;
         var _loc4_:Number = this.var_378.z;
         this.var_378.assign(param1);
         if(this.var_378.x != _loc2_ || this.var_378.y != _loc3_ || this.var_378.z != _loc4_)
         {
            ++this.var_169;
         }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1220.assign(_loc22_);
         }
         else
         {
            this.var_1220.assign(_loc17_);
         }
         ++this.var_169;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_439;
         _loc2_.z *= this.var_438;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1220);
         if(_loc3_ < this.var_2880 || _loc3_ > this.var_2879)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_439;
            _loc2_.z *= this.var_438;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1220);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_92.x * this.var_437,this.var_92.y * this.var_439,this.var_92.z * this.var_438);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_152;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_437,param2.y * this.var_439,param2.z * this.var_438);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_437,param3.y * this.var_439,param3.z * this.var_438);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_437,param4.y * this.var_439,param4.z * this.var_438);
