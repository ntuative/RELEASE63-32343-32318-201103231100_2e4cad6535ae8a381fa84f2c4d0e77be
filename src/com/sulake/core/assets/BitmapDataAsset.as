package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_561:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_517 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_109 is BitmapDataAsset)
         {
            ...
            this.var_1460 = BitmapDataAsset(this.var_109).var_1460;
            this.var_1461 = BitmapDataAsset(this.var_109).var_1461;
            if(this._bitmap != null)
            {
               this.var_109 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1460 = _loc4_ == "1" || _loc4_ == "AvailabilityTimeMessageParser";
                  break;
               case "flipV":
                  this.var_1461 = _loc4_ == "1" || _loc4_ == "AvailabilityTimeMessageParser";
                  break;
            }
            _loc2_++;
         }
