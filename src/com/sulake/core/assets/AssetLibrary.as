package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_847:String = "AssetLibraryLoaded";
      
      public static const const_1521:String = "AssetLibraryUnloaded";
      
      public static const const_1435:String = "AssetLibraryLoadError";
      
      private static const const_422:String = "name";
      
      private static const const_928:String = "asset";
      
      private static const const_926:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_927:String = "library";
      
      private static var var_288:Dictionary;
      
      private static var var_1575:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_564 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_927);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_422);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_926);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_564 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_860.splice(var_860.indexOf(this),1);
            --var_470;
            this.var_471 = null;
            this.var_859 = null;
            this.var_153 = null;
      ...
      {
         if(this.var_564 == param1.url && this.var_858)
         {
            if(!this.var_857 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_565);
            }
            this.var_857 = param2;
      ...
      public function unload() : void
      {
         ...
         this.var_858 = false;
         this.var_564 = null;
         dispatchEvent(new Event(AssetLibrary.const_1521));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1099,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_405;
                     this.var_407.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_407.length ? this.getAssetByName(this.var_407[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_153)
         {
            ...
            {
               return this.var_407.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_153[param1] != null || (this.var_565 != null ? this.var_565[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1575.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_288.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_288[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_288[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_406[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_288)
            {
               _loc3_ = AssetTypeDeclaration(var_288[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_288)
            {
               _loc4_ = AssetTypeDeclaration(var_288[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_565 = _loc2_.resource;
         this.var_564 = _loc2_.url;
         if(this.var_857)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_565);
         }
         this.var_858 = true;
         dispatchEvent(new Event(AssetLibrary.const_847));
         dispatchEvent(new Event(AssetLibrary.const_1015));
         if(this.var_857)
         {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_927);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_422).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_564 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_565[param1]);
                  _loc6_ = _loc3_.child(const_926);
                  if(_loc6_.length())
                  {
