package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1046 = param2 == null ? "" : param2.url;
         this._type = param1;
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_329 < var_2841)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1046 + (this.var_1046.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_329),this.var_1050);
               return true;
            }
         }
         return false;
