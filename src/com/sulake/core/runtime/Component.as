package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1217:uint = 4;
       
      
      protected var var_708:uint = 0;
      
      protected var var_1300:String = "";
      
      protected var var_2076:String = "";
      ...
      private var var_520:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_520 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_520.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_520.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1423 & const_1217)
         {
            if(_loc3_ == 0)
            {
               if(this.var_520.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_708 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_520.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_520.getStructByIndex(_loc8_);
