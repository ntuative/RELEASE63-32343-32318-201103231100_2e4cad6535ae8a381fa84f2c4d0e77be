package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1330:String = "asset-libraries";
      ...
      private static const const_1331:String = "component-libraries";
      
      private static const const_1332:String = "library";
      
      private static const const_1325:String = "error_data";
      
      private static const const_1328:String = "error_cat";
      
      private static const const_1326:String = "error_desc";
       
      
      private var var_360:LibraryLoaderQueue;
      
      private var var_757:IEventDispatcher;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_685:
               ...
               var_399.addChild(new ProfilerViewer(this.var_204));
               break;
            case Core.const_506:
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1325,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1328,String(param3));
         ErrorReportStorage.setParameter(const_1326,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_757 = loadingEventDelegate;
         if(this.var_360 == null)
         {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_277,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_277,e);
         }
         try
         {
            node = config.child(const_1331)[0];
            if(node != null)
            {
               list = node.child(const_1332);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_277,e);
         }
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_757)
         {
            this.var_757.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_757)
         {
            ...
            this.var_757.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_757)
                  {
                     this.var_757.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_508 - this.var_360.length,this.var_508,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_204 ? 0 : this.var_1423 & 0;
         if(_loc3_ == Core.const_506)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_100)
         {
            ...
            {
               if(this.var_619[priority] < priority)
               {
                  ++this.var_619[priority];
                  skip = true;
               }
            }
            if(!skip)
