package com.sulake.core.communication.messages
{
   ...
   public class MessageDataWrapper implements IMessageDataWrapper
   {
      ...
      private var var_1219:IProtocolDecoder;
      ...
      {
         return this.var_1219.readString(this._data);
      }
      
      public function readInteger() : int
      {
         return this.var_1219.readInteger(this._data);
      }
      
      public function readBoolean() : Boolean
      {
         return this.var_1219.readBoolean(this._data);
      }
      
      public function readShort() : Short
      {
         return this.var_1219.readShort(this._data);
      }
