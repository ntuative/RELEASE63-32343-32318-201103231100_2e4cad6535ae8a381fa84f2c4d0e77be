package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_304 = param1;
         if(this.var_304 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_304)
         {
      ...
      {
         return this.var_306 == int.MIN_VALUE && this.var_303 == int.MAX_VALUE && this.var_304 == int.MIN_VALUE && this.var_305 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            if(this._target.height < this.var_304)
            {
               this._target.height = this.var_304;
            }
