package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1036:String = "_EXCLUDE";
      
      public static const const_1808:String = "_INCLUDE";
      
      public static const const_1916:String = "_TEMP";
      
      private static const const_1295:String = "layout";
      
      private static const const_944:String = "window";
      
      private static const const_943:String = "variables";
      
      private static const const_945:String = "filters";
      
      private static const const_422:String = "name";
      
      private static const const_1307:String = "style";
      
      private static const const_600:String = "params";
      
      private static const const_1305:String = "tags";
      ...
      private static const const_1300:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1147:String = "blend";
      
      private static const const_1298:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1299:String = "treshold";
      ...
      private static const const_1292:String = "height_max";
      ...
      private static const const_1301:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1304:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1292:Dictionary;
      
      protected var var_1293:Dictionary;
      
      protected var var_1042:Dictionary;
      
      protected var var_1557:Dictionary;
      
      protected var var_2063:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1292,this.var_1293);
         this.var_1042 = new Dictionary();
         this.var_1557 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1042,this.var_1557);
         this.var_2063 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1304,const_49);
         return param1.replace(const_1301,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1292)
            {
               delete this.var_1292[_loc1_];
            }
            for(_loc1_ in this.var_1293)
            {
               delete this.var_1293[_loc1_];
            }
            for(_loc1_ in this.var_1042)
            {
               delete this.var_1042[_loc1_];
            }
            for(_loc1_ in this.var_1557)
            {
               delete this.var_1557[_loc1_];
            }
            this.var_2063.dispose();
            this.var_2063 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1295)
         {
            _loc8_ = param1.child(const_943);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_945).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1292[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_422,variables,"")));
         style = uint(this.parseAttribute(xml,const_1307,variables,style));
         params = uint(this.parseAttribute(xml,const_600,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1305,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_160));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_160));
         rect.width = Number(this.parseAttribute(xml,const_1293,variables,const_160));
         rect.height = Number(this.parseAttribute(xml,const_1294,variables,const_160));
         visible = this.parseAttribute(xml,const_1297,variables,visible.toString()) == const_599;
         ...
         if(xml.child(const_600).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_422,variables,"") as String;
               if(this.var_1042[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_422)) + "\"!");
               }
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1300,variables,caption)));
         if(tag != const_49)
         {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_943)[0]),tags) as WindowController;
         ...
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1292,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_599;
         blend = Number(this.parseAttribute(xml,const_1147,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1298,variables,window.clipping.toString()) == const_599;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1299,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_945).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1293[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1036) == -1)
                  {
