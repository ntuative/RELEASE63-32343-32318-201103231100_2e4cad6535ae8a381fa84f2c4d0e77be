package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_514:Array;
      ...
      private static const const_1347:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_87[const_194],var_87[ITALIC],var_87[BOLD]];
            var_87.reset();
            var_87[const_194] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_514.indexOf(_loc4_.name) == -1)
            {
               var_514.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "AvailabilityTimeMessageParser" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_604) != countSubStrings(param1,const_605))
         {
            throw new Error("Mismatching amount of \"" + const_604 + "\" versus \"" + const_605 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1347) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1348) + 2,_loc5_.length);
            }
