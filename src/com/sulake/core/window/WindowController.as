package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1260:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1254:String = "_COLORIZE";
      
      protected static const const_1739:String = "_IGNORE_INHERITED_STYLE";
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_806 = _loc13_.blend;
            var_464 = _loc13_.var_2826;
      ...
      {
         return this.var_685 != null ? this.var_685 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_465 = param1;
         var_237 = !!var_465 ? uint(var_237 | var_553) : uint(var_237 & 16777215);
      ...
      {
         var_553 = param1 << 24;
         var_237 = !!var_465 ? uint(var_553 | var_237) : uint(16777215 & var_237);
         _context.invalidate(this,var_11,WindowRedrawFlag.REDRAW);
      }
      
      public function set blend(param1:Number) : void
      {
         var_806 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1147);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_491,this,null);
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_84 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_571,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set clipping(param1:Boolean) : void
      {
         ...
         {
            var_678 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_433,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_481,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1090,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_739,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_84,var_19,_context,var_11,null,this.var_685,this.properties,var_837.concat(),_id) as WindowController;
         ...
         _loc2_.var_678 = var_678;
         _loc2_.var_317 = var_317;
         _loc2_.var_806 = var_806;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2695 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1026,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_730,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_519,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_172,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
         }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = 0;
         if(!testParamFlag(WindowParam.const_776))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               ...
               case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                  ...
                  break;
               case WindowMouseEvent.const_314:
                  return false;
            }
         }
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_172:
                  ...
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_583,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(testParamFlag(WindowParam.const_188,WindowParam.const_164))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_203,WindowParam.const_163))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_19 = _loc10_;
                        _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_296,this._parent,this);
               ...
               case WindowNotifyEvent.const_519:
                  _context.invalidate(this,var_11.union(var_62),WindowRedrawFlag.const_504);
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1252,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
                        _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_316,this._parent,this);
                        this._parent.update(this,_loc6_);
                        _loc6_.recycle();
                     }
                  }
               ...
               case WindowNotifyEvent.const_372:
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_677,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_491:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1178);
                  break;
               case WindowNotifyEvent.const_571:
                  ...
                  while(--_loc8_ > -1)
                  {
                     ...
                     if(_loc9_.tags.indexOf(const_1739) == -1)
                     {
                        _loc9_.style = var_84;
                     }
                  }
               ...
               case WindowNotifyEvent.const_433:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_22)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_504);
                     }
                  }
                  else if(var_19 & 0)
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1249:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1247:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1523:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1651:
               _loc2_ = "null";
               break;
      ...
      public function setStateFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_state != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_491,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_84 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_571,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_19 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_433,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_155,WindowParam.const_164);
         var _loc2_:* = !testParamFlag(WindowParam.const_136,WindowParam.const_163);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_410)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_384)
               {
                  _loc3_.x += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_579)
         {
            return true;
         }
         _state = WindowState.const_579;
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1039,this,null);
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1169;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1192,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      {
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1215,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1247;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1141,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1079,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_750;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1045,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1259 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1259 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_806,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
