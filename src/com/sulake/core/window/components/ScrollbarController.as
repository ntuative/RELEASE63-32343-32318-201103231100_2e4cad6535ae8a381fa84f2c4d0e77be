package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1281:String = "increment";
      
      private static const const_1282:String = "decrement";
      
      private static const const_940:String = "slider_track";
      ...
      protected var var_679:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_20 != null && !this.var_20.disposed)
         {
            ...
            this.var_20.removeEventListener(WindowEvent.const_581,this.onScrollableScrolled);
         }
         this.var_20 = param1;
         if(this.var_20 != null && !this.var_20.disposed)
         {
            this.var_20.addEventListener(WindowEvent.const_46,this.onScrollableResized);
            this.var_20.addEventListener(WindowEvent.const_581,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_940) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_314)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_679;
                  }
                  else
                  {
                     this.scrollV -= this.var_679;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN || param1.type == WindowTouchEvent.const_518)
         {
            ...
            else if(param2.name == const_1282)
            {
               if(this.var_20)
               {
                  this.var_1102 = true;
         ...
         if(param1.type == WindowMouseEvent.const_314)
         {
