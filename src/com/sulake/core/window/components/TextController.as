package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1253:Dictionary = createPropertySetterTable();
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_430,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_430 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_430,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_774 ? true : null;
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1130) ? new PropertyStruct(PropertyDefaults.const_837,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1186) : PropertyDefaults.const_1591);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1201 ? new PropertyStruct(PropertyDefaults.const_675,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1196) : PropertyDefaults.const_1679);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1230 ? new PropertyStruct(PropertyDefaults.const_1057,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1083) : PropertyDefaults.const_1472);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_843) ? new PropertyStruct(PropertyDefaults.const_348,this._field.textColor,PropertyStruct.const_153,true) : PropertyDefaults.const_1034);
         ...
         _loc1_.push(this.var_41.left != PropertyDefaults.const_863 ? new PropertyStruct(PropertyDefaults.const_259,this.var_41.left,PropertyStruct.const_41,true) : PropertyDefaults.const_557);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_713 ? new PropertyStruct(PropertyDefaults.const_225,this.var_41.top,PropertyStruct.const_41,true) : PropertyDefaults.const_468);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_658 ? new PropertyStruct(PropertyDefaults.const_264,this.var_41.right,PropertyStruct.const_41,true) : PropertyDefaults.const_511);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_829 ? new PropertyStruct(PropertyDefaults.const_260,this.var_41.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_497);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1150 ? new PropertyStruct(PropertyDefaults.const_623,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1706);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_237,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_237,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_237,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
