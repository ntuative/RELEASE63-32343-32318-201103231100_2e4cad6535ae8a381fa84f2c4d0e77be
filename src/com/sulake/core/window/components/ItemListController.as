package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2891:Number = 0.0;
      
      protected var var_2892:Number = 0.0;
      
      protected var var_1044:Boolean = true;
      
      protected var var_467:Boolean = false;
      
      protected var var_1296:Boolean = false;
      
      protected var var_2071:int = 0;
      
      protected var var_2073:int = 0;
      
      protected var var_1298:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_111 = 0;
         this.var_94 = 0;
         this._horizontal = param2 == WindowType.const_412;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_177 = var_465 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_380,WindowStyle.const_741,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_587,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1296;
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_681)
         {
            ...
            dispatchEvent(new WindowEvent(WindowEvent.const_581,this,null));
         }
      }
      ...
      {
         this.var_2891 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2892 = Math.max(param1,0);
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_587,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN:
               this.var_2071 = _loc3_;
               this.var_2073 = _loc4_;
               this.var_1298 = 0;
               this.var_1295 = 0;
               this.var_1297 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_191:
               if(this.var_1297)
               {
                  this.var_1298 = this.var_2071 - _loc3_;
                  this.var_1295 = this.var_2073 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1298 != 0 && this.var_111 != 0)
                     {
                        this.scrollH += this.var_1298 / this.var_111;
                     }
                  }
                  else if(this.var_1295 != 0 && this.var_94 != 0)
                  {
                     this.scrollV += this.var_1295 / this.var_94;
                  }
                  this.var_2071 = _loc3_;
                  this.var_2073 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_184:
               if(this.var_1297)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1298,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1295);
                  }
                  this.var_1297 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1044 && !this.var_556 && this._container)
         {
            this.var_556 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_696)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_339,this._spacing,PropertyStruct.const_41,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1024);
         }
         if(this.var_1044 != PropertyDefaults.const_1211)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_836,this.var_1044,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1560);
         }
         if(this.var_467 != PropertyDefaults.const_1025)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_894,this.var_467,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1647);
         }
         if(this.var_1296 != PropertyDefaults.const_1113)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_744,this.var_1296,PropertyStruct.const_38,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_339:
                  ...
                  break;
               case PropertyDefaults.const_894:
               ...
               case PropertyDefaults.const_836:
                  this.var_1044 = _loc2_.value as Boolean;
                  break;
            }
         }
