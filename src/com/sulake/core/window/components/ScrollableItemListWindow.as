package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_436:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_436)
         {
            this.var_436.removeEventListener(WindowEvent.const_310,this.scrollBarEventProc);
            this.var_436.removeEventListener(WindowEvent.const_262,this.scrollBarEventProc);
            this.var_436 = null;
         }
         if(this.var_1215)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1215)
         {
            this.var_1215 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_436)
         {
            this.var_436 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_436)
            {
               this.var_436.addEventListener(WindowEvent.const_310,this.scrollBarEventProc);
               this.var_436.addEventListener(WindowEvent.const_262,this.scrollBarEventProc);
            }
         }
         return this.var_436;
      }
