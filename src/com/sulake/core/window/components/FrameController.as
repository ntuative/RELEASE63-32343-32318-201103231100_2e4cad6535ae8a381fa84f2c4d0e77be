package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1387:String = "_TITLE";
      
      private static const const_1413:String = "_HEADER";
      
      private static const const_1415:String = "_CONTENT";
      
      private static const const_1414:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1524:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1387) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1524 = findChildByTag(const_1413) as IHeaderWindow;
            if(!this.var_1524)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_191 = findChildByTag(const_1415) as IWindowContainer;
            if(!this.var_191)
            {
      ...
      {
         return findChildByTag(const_1414) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1254,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1040 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_325,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,_loc3_.left,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_225,_loc3_.top,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_264,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,0 - _loc3_.bottom,PropertyStruct.const_41,_loc2_));
         }
         else
         {
