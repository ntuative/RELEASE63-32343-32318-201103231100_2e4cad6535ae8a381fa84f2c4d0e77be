package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1363:String = "_SELECTOR";
      
      private static const const_1362:String = "_CONTENT";
       
      
      protected var var_1048:ITabSelectorWindow;
      
      protected var var_2078:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1048 = findChildByTag(const_1363) as ITabSelectorWindow;
            if(this.var_1048 != null)
            {
               this.var_1048.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2078 = findChildByTag(const_1362) as IWindowContainer;
         }
      ...
      {
         return this.var_1048.numSelectables;
      }
