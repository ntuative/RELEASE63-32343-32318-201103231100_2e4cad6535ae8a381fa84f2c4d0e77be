package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_883:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_882:String = "default";
      
      private var var_1083:String = null;
      
      private var var_1609:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1083 == param2)
         {
            return;
         }
         param1.var_1083 = param2;
         param1.var_1609 = null;
         if(param1.var_1083 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1083);
            param1.var_1609 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_844.indexOf(param1) > -1)
         {
            this.var_882 = param1;
         }
      }
      ...
      {
         return this.var_882 == LinkTarget.const_31 ? defaultLinkTarget : this.var_882;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1609;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_736)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_882 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_723,this.var_882,PropertyStruct.const_54,true,PropertyDefaults.const_844));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1501);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_882 = _loc2_.value as String;
               break;
            }
