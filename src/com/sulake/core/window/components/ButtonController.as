package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_413:String = "_BTN_TEXT";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_413);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowNotifyEvent)
         {
            switch(event.type)
            {
               ...
               case WindowNotifyEvent.const_750:
                  try
                  {
                     getChildByName(const_413).blend = getChildByName(const_413).blend + 0.5;
                  }
                  catch(e:Error)
                  {
                  }
