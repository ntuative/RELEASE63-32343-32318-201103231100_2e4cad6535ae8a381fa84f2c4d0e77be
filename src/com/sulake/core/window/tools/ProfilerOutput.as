package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1487:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_168:IProfiler;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_168)
         {
            this.var_168.removeStopEventListener(this.refresh);
            this.var_168 = null;
         }
         if(!this.var_168 && param1)
         {
            this.var_168 = param1;
            this.var_168.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_879)
            {
               this.var_1871 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_168.getProfilerAgentsInArray();
         ...
         if(this.var_1871)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_168.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_168.numBitmapAssetInstances + " / " + this.var_168.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_973.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_168.numTrackedBitmapDataInstances + " / " + this.var_168.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1487() as ByteArray;
