package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_844:Dictionary;
      
      protected var var_843:Dictionary;
      ...
      {
         super(param1);
         this.var_844 = new Dictionary(false);
         this.var_843 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_993 = null;
            for(_loc1_ in this.var_844)
            {
               _loc2_ = this.var_844[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_844[_loc1_];
            }
            this.var_844 = null;
            for(_loc1_ in this.var_843)
            {
               _loc2_ = this.var_843[_loc1_] as BitmapData;
               _loc2_.dispose();
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_295)
                  {
                     var_34.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_562)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_275)
                  {
                     _loc12_ = true;
                     var_34.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_295)
                  {
                     var_34.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_562)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_275)
                  {
                     _loc13_ = true;
                     var_34.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_275 || _loc10_.scaleH == SkinLayoutEntity.const_275)
                  {
                  ...
                  {
                     this.var_993.a = 0 / _loc17_.width;
                     this.var_993.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_34.width,var_34.height,false);
                     _loc30_.draw(_loc17_,this.var_993);
                     _loc31_ = new BitmapData(var_34.width,var_34.height,true,0);
                     _loc31_.draw(_loc18_,this.var_993,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_295)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_295)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_844[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_843[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
