package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1611:uint = 0;
      
      public static const const_739:uint = 1;
      
      public static const const_1174:uint = 2;
      
      public static const const_869:uint = 4;
      
      public static const const_1518:uint = 8;
      
      public static const const_1673:uint = 16;
      
      public static const const_1953:uint = 64;
      
      public static const const_1834:uint = 128;
      
      public static const const_1064:uint = 256;
         ...
         if(this.var_840)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2075,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2075,16777215);
                  }
                  var_332 += bitmap.width * bitmap.height * 4;
               }
