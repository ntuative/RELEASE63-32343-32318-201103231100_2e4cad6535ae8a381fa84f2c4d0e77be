package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private var var_2486:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2488 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1792,this.var_2488);
         this.var_2486 = new Dictionary();
         this.var_2487 = new Dictionary();
         StateCodeTable.fillTables(this.var_2486,this.var_2487);
         this.var_425 = new Dictionary();
         this.var_425[const_1344] = BitmapSkinRenderer;
         this.var_425[const_1345] = BitmapDataRenderer;
         this.var_425[const_1341] = FillSkinRenderer;
         this.var_425[const_1343] = TextSkinRenderer;
         this.var_425[const_1342] = LabelRenderer;
         this.var_425[const_1340] = ShapeSkinRenderer;
         this.var_425[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_425[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_333 == null)
         {
            var_333 = new Array();
            var_333.push(WindowState.const_70);
            var_333.push(WindowState.const_82);
            ...
            var_333.push(WindowState.const_106);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2826 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "AvailabilityTimeMessageParser" : false;
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_948[param1] = new Array(const_956);
         }
         this.var_948[param1][param2] = param3;
         if(this.var_947[param1] == null)
         {
            this.var_947[param1] = new Array(const_956);
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_948[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_200)
            {
               _loc4_ = _loc3_["null"];
            }
         }
